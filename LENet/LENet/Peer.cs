...
namespace LENet
{
    ...
    {
        public const ushort DEFAULT_ROUND_TRIP_TIME = 0x1F4;
        public const byte DEFAULT_PACKET_THROTTLE = 0x20;
        public const byte PACKET_THROTTLE_SCALE = 0x20;
        public const byte PACKET_THROTTLE_COUNTER = 0x7;
        public const byte PACKET_THROTTLE_ACCELERATION = 0x2;
        public const byte PACKET_THROTTLE_DECELERATION = 0x2;
        public const ushort PACKET_THROTTLE_INTERVAL = 0x1388;
        public const uint PACKET_LOSS_SCALE = 0x10000;
        public const uint WINDOW_SIZE_SCALE = 0x10000;
        public const byte TIMEOUT_LIMIT = 0x20;
        public const ushort TIMEOUT_MINIMUM = 0x7530;
        public const ushort TIMEOUT_MAXIMUM = 0x7530;
        public const ushort PING_INTERVAL = 0x1F4;
        public const byte UNSEQUENCED_WINDOWS = 0x40;
        public const ushort UNSEQUENCED_WINDOW_SIZE = 0x400;
        public const byte FREE_UNSEQUENCED_WINDOWS = 0x20;
        public const byte RELIABLE_WINDOWS = 0x10;
        public const ushort RELIABLE_WINDOW_SIZE = 0x1000;
        public const byte FREE_RELIABLE_WINDOWS = 0x8;
