...
class GetCapturePointPositionsClass : AImission_bt
{


     public bool GetCapturePointPositions(
      ...
      Vector3 _CapturePointPositionA = default( Vector3 );
      Vector3 _CapturePointPositionB = default(Vector3);
        Vector3 _CapturePointPositionC = default(Vector3);
        Vector3 _CapturePointPositionD = default(Vector3);
        Vector3 _CapturePointPositionE = default(Vector3);
        bool result = 
