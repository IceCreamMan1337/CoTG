...
class DrMundo_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
     ...
     bool DrMundo_Behavior_Dominion() {

        return
        (
            // Sequence name :DrMundo_Behavior_Dominion
            (
                  ...
                  (
                        ...
                        dominionInitialization.DominionInitialization(
                              ...
                              out GarrisonSlot,
                              Self) &&
                        // Sequence name :Initialization_DrMundo
                        (
                              SetVarString(
                                    out _Champion,
                                    "DrMundo") &&
