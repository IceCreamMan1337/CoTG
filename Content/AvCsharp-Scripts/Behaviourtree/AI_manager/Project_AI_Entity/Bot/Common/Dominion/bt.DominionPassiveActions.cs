...
{
    private DominionAtBaseHealAndBuyClass dominionAtBaseHealAndBuy = new DominionAtBaseHealAndBuyClass();
    private DominionLevelUpClass dominionLevelUp= new DominionLevelUpClass();
