...
class KillChampionAcquisitionClass : AI_Characters 
{
    ...
    private FindTargetByDistanceHealthScoreClass findTargetByDistanceHealthScore = new FindTargetByDistanceHealthScoreClass();
    private DistanceHealthScoreClass distanceHealthScore = new DistanceHealthScoreClass();
