...
class Shyvana_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Shyvana_Behavior_Dominion() {
        return
              // Sequence name :Shyvana_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Shyvana
                          (
                                SetVarString(
                                      out _Champion,
                                      "Shyvana") &&
