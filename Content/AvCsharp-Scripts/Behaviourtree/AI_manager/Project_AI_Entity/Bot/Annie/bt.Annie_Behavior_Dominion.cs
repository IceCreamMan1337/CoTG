...
class Annie_Behavior_DominionClass : AI_Characters 
{
    ...
    bool Annie_Behavior_Dominion()
    {
        // Sequence name :Bot.Annie.Annie_Behavior_Dominion
       return
            // Sequence name :Annie_Behavior_Dominion
            (
                  ...
                  (
                        ...
                        dominionInitialization.DominionInitialization(
                              ...
                              out GarrisonSlot, 
                              Self) &&
                        // Sequence name :Initialization_Annie
                        (
                              SetVarString(
                                    out _Champion, 
                                    "Annie") &&
                              ...
                              (
                                   SetProcedureVariable(
                                          out _DominionAttackMinion, "DominionAttackMinion") &&
                                    SetProcedureVariable(
