...
class Caitlyn_KillChampionAttackSequenceClass : AI_Characters 
{
    ...
    public bool Caitlyn_KillChampionAttackSequence(
         ...
         )
      {
        ...
        bool result =
            // Sequence name :CaitlynKillSequence
            (
                  ...
                  (
                        ...
                        // Sequence name :CaitlynKillChampion
                        (
                              // Sequence name :CastW
                              (
