...
class Caitlyn_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Caitlyn_Behavior_Dominion() {
        return
              // Sequence name :Caitlyn_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Caitlyn
                          (
                                SetVarString(
                                      out _Champion,
                                      "Caitlyn") &&
