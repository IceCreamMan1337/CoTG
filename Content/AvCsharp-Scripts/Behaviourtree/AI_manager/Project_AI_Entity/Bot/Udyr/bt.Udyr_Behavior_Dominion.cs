...
class Udyr_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Udyr_Behavior_Dominion() {
        return
              // Sequence name :Udyr_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Udyr
                          (
                                SetVarString(
                                      out _Champion,
                                      "Udyr") &&
