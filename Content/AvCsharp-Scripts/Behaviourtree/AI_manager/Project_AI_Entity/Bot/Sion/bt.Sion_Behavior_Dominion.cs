...
class Sion_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Sion_Behavior_Dominion() {
        // Sequence name :Sion_Behavior_Dominion
        return (
               ...
               (
                     ...
                     dominionInitialization.DominionInitialization(
                           ...
                           out GarrisonSlot,
                           Self) &&
                     // Sequence name :Initialization_Sion
                     (
                           SetVarString(
                                 out _Champion,
                                 "Sion") &&
