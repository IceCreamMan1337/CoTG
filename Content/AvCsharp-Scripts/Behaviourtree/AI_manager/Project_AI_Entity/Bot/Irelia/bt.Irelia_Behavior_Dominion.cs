...
class Irelia_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Irelia_Behavior_Dominion() {
        return
              // Sequence name :Irelia_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Irelia
                          (
                                SetVarString(
                                      out _Champion,
                                      "Irelia") &&
