...
class Zilean_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Zilean_Behavior_Dominion() {
        return
              // Sequence name :Zilean_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Zilean
                          (
                                SetVarString(
                                      out _Champion,
                                      "Zilean") &&
