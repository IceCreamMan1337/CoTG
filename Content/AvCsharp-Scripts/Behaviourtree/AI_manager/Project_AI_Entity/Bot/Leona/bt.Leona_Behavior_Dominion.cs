...
class Leona_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
     ...
     bool Leona_Behavior_Dominion() {
        return
                   // Sequence name :Leona_Behavior_Dominion
                   (
                         ...
                         (
                               ...
                               dominionInitialization.DominionInitialization(
                                     ...
                                     out GarrisonSlot,
                                     Self) &&
                               // Sequence name :Initialization_Leona
                               (
                                     SetVarString(
                                           out _Champion,
                                           "Leona") &&
