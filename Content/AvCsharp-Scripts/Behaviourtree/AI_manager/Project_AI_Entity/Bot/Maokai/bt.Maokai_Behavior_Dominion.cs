...
class Maokai_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Maokai_Behavior_Dominion() {
        return
              // Sequence name :Maokai_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Maokai
                          (
                                SetVarString(
                                      out _Champion,
                                      "Maokai") &&
