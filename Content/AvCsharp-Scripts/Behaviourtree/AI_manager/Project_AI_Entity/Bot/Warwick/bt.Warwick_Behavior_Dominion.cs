...
class Warwick_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Warwick_Behavior_Dominion() {
        return
              // Sequence name :Warwick_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Warwick
                          (
                                SetVarString(
                                      out _Champion,
                                      "Warwick") &&
                         ...
                         dominionReferenceUpdate.DominionReferenceUpdate(
                          ...
                          (
                             dominionPassiveActions.DominionPassiveActions(
                                ...
                                // Sequence name :ToggleBloodScentOn
                                (
                                      TestUnitHasBuff(
                                            Self,
                                            default,
