...
class Chogath_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
     ...
     bool Chogath_Behavior_Dominion() {
        ...
        (
              ...
              (
                    ...
                    dominionInitialization.DominionInitialization(
                          ...
                          out GarrisonSlot,
                          Self) &&
                    // Sequence name :Initialization_Chogath
                    (
                          SetVarString(
                                out _Champion,
                                "Chogath") &&
                   ...
                   dominionReferenceUpdate.DominionReferenceUpdate(
                    ...
                    (
                        dominionPassiveActions.DominionPassiveActions(
                          ...
                          // Sequence name :ToggleVorpalSpikesOn
                          (
                                TestUnitHasBuff(
                                      Self,
                                      default,
