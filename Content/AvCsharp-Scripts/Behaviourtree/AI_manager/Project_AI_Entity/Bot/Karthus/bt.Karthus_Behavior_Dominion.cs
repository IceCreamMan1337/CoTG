...
class Karthus_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Karthus_Behavior_Dominion() {
        return
            // Sequence name :Karthus_Behavior_Dominion
            (
                  ...
                  (
                        ...
                        dominionInitialization.DominionInitialization(
                              ...
                              out GarrisonSlot,
                              Self) &&
                        // Sequence name :Initialization_Karthus
                        (
                              SetVarString(
                                    out _Champion,
                                    "Karthus") &&
