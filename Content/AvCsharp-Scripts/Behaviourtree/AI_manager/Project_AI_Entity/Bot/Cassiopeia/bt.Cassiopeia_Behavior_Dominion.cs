...
class Cassiopeia_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Cassiopeia_Behavior_Dominion() {
            ...
            (
              ...
              (
                    ...
                    dominionInitialization.DominionInitialization(
                          ...
                          out GarrisonSlot,
                          Self) &&
                    // Sequence name :Initialization_Cassiopeia
                    (
                          SetVarString(
                                out _Champion,
                                "Cassiopeia") &&
              ...
              (
                   ...
                   dominionReferenceUpdate.DominionReferenceUpdate(
                    ...
                    targetVisibilityUpdates.TargetVisibilityUpdates(
                          ...
                          Target,
                          Self) &&
                    // Sequence name :Cassiopeia_Actions
                    (
