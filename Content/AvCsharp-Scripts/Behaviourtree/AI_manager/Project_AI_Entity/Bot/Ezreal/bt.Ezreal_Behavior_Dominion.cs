...
class Ezreal_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
     ...
     bool Ezreal_Behavior_Dominion() {
        return
              // Sequence name :Ezreal_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Ezreal
                          (
                                SetVarString(
                                      out _Champion,
                                      "Ezreal") &&
