...
class Vladimir_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Vladimir_Behavior_Dominion() {
        return
              // Sequence name :Vladimir_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Vladimir
                          (
                                SetVarString(
                                      out _Champion,
                                      "Vladimir") &&
                    ...
                    (
                         ...
                         dominionReferenceUpdate.DominionReferenceUpdate(
                          ...
                          targetVisibilityUpdates.TargetVisibilityUpdates(
                                ...
                                Target,
                                Self) &&
                          // Sequence name :Vladimir_Actions
                          (
