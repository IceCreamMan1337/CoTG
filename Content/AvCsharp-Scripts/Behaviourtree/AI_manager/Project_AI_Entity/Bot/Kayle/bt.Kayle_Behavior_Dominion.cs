...
class Kayle_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
     ...
     bool Kayle_Behavior_Dominion() {
        return
              // Sequence name :Kayle_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Kayle
                          (
                                SetVarString(
                                      out _Champion,
                                      "Kayle") &&
