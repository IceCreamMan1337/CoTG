...
class Tristana_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Tristana_Behavior_Dominion() {
        return
              // Sequence name :Tristana_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Tristana
                          (
                                SetVarString(
                                      out _Champion,
                                      "Tristana") &&
                    ...
                    (
                         ...
                         dominionReferenceUpdate.DominionReferenceUpdate(
                          ...
                          targetVisibilityUpdates.TargetVisibilityUpdates(
                                ...
                                Target,
                                Self) &&
                          // Sequence name :Tristana_Actions
                          (
