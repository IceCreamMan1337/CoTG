...
class Alistar_Behavior_DominionClass : AI_Characters 
{
    private InitializationClass initializationClass =  new InitializationClass();
    private DominionInitializationClass dominionInitialization = new DominionInitializationClass();
    private DominionTaskInitializationClass dominionTaskInitialization = new DominionTaskInitializationClass();
    private DominionReferenceUpdateClass dominionReferenceUpdate = new DominionReferenceUpdateClass();
    private TargetVisibilityUpdatesClass targetVisibilityUpdates = new TargetVisibilityUpdatesClass();
    private DominionPassiveActionsClass dominionPassiveActions = new DominionPassiveActionsClass();
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
    bool  Alistar_Behavior_Dominion() { 
      // Sequence name :Bot.Alistar.Alistar_Behavior_Dominion
      
            // Sequence name :Alistar_Behavior_Dominion
            return 
                  ...
                  (
                        ...
                        dominionInitialization.DominionInitialization(
                              ...
                              out GarrisonSlot, 
                              Self) &&
                        // Sequence name :Initialization_Alistar
                        (
                              SetVarString(
                                    out _Champion, 
                                    "Alistar") &&
                              ...
                              (
                                    ...
                                    SetProcedureVariable(
                                          out _HealAbilities, "Heal") &&  //function 
                                    SetProcedureVariable(
