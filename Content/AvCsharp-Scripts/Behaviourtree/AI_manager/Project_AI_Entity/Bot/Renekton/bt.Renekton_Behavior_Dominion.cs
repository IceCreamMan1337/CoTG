...
class Renekton_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Renekton_Behavior_Dominion() {
        return
              // Sequence name :Renekton_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Renekton
                          (
                                SetVarString(
                                      out _Champion,
                                      "Renekton") &&
                    ...
                    (
                         ...
                         dominionReferenceUpdate.DominionReferenceUpdate(
                          ...
                          targetVisibilityUpdates.TargetVisibilityUpdates(
                                ...
                                Target,
                                Self) &&
                          // Sequence name :Renekton_Actions
                          (
