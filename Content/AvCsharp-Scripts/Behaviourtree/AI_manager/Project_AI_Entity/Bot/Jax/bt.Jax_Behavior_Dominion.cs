...
class Jax_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
     ...
     bool Jax_Behavior_Dominion() {
        return
              // Sequence name :Jax_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Jax
                          (
                                SetVarString(
                                      out _Champion,
                                      "Jax") &&
