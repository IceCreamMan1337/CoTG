...
class Morgana_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
     ...
     bool Morgana_Behavior_Dominion() {
        return
              // Sequence name :Morgana_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Morgana
                          (
                                SetVarString(
                                      out _Champion,
                                      "Morgana") &&
