...
class Galio_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
     ...
     bool Galio_Behavior_Dominion() {

        return
        (
            // Sequence name :Galio_Behavior_Dominion
            (
                  ...
                  (
                        ...
                        dominionInitialization.DominionInitialization(
                              ...
                              out GarrisonSlot,
                              Self) &&
                        // Sequence name :Initialization_Galio
                        (
                              SetVarString(
                                    out _Champion,
                                    "Galio") &&
