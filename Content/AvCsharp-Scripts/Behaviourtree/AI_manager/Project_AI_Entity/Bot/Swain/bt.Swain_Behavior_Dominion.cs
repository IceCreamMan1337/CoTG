...
class Swain_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Swain_Behavior_Dominion() { return
            // Sequence name :Swain_Behavior_Dominion
            (
                  ...
                  (
                        ...
                        dominionInitialization.DominionInitialization(
                              ...
                              out GarrisonSlot,
                              Self) &&
                        // Sequence name :Initialization_Swain
                        (
                              SetVarString(
                                    out _Champion,
                                    "Swain") &&
