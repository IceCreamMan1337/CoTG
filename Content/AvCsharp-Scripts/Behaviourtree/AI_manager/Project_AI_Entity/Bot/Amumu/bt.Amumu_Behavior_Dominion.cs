...
class Amumu_Behavior_DominionClass : AI_Characters 
{
    ...
    // Sequence name :Bot.Amumu.Amumu_Behavior_Dominion
    bool Amumu_Behavior_Dominion()
    {
        // Sequence name :Amumu_Behavior_Dominion
        return 
                  ...
                  (
                       ...
                       initializationClass.Initialization(
                        ...
                        dominionInitialization.DominionInitialization(
                              ...
                              out GarrisonSlot,
                              Self) &&
                        // Sequence name :Initialization_Amumu
                        (
                              SetVarString(
                                    out _Champion, 
                                    "Amumu") &&
                              ...
                              (
                                   ...
                                   SetProcedureVariable(
                                    ...
                                    SetProcedureVariable(
                                         out _PostActionBehavior, "PostActionBehavior")
                              )
                        )
                  ) ||
