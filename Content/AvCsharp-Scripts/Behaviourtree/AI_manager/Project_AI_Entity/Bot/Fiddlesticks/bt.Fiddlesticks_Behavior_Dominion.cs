...
class Fiddlesticks_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Fiddlesticks_Behavior_Dominion() {


        return (
            // Sequence name :Fiddlesticks_Behavior_Dominion
            (
                  ...
                  (
                        ...
                        dominionInitialization.DominionInitialization(
                              ...
                              out GarrisonSlot,
                              Self) &&
                        // Sequence name :Initialization_Fiddlesticks
                        (
                              SetVarString(
                                    out _Champion,
                                    "Fiddlesticks") &&
                  ...
                  (
                       ...
                       dominionReferenceUpdate.DominionReferenceUpdate(
                        ...
                        targetVisibilityUpdates.TargetVisibilityUpdates(
                              ...
                              Target,
                              Self) &&
                        // Sequence name :Fiddlesticks_Actions
                        (
