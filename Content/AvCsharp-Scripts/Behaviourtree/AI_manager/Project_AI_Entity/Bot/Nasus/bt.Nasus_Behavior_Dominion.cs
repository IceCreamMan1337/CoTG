...
class Nasus_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Nasus_Behavior_Dominion() {
        return
              // Sequence name :Nasus_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Nasus
                          (
                                SetVarString(
                                      out _Champion,
                                      "Nasus") &&
