...
class Soraka_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
     ...
     bool Soraka_Behavior_Dominion() {
        return
              // Sequence name :Soraka_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Soraka
                          (
                                SetVarString(
                                      out _Champion,
                                      "Soraka") &&
