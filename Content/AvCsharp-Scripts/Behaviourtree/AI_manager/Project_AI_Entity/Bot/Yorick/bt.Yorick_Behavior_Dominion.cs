...
class Yorick_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Yorick_Behavior_Dominion() {
        return
              // Sequence name :Yorick_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Yorick
                          (
                                SetVarString(
                                      out _Champion,
                                      "Yorick") &&
