...
class Trundle_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Trundle_Behavior_Dominion() {
        return
              // Sequence name :Trundle_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Trundle
                          (
                                SetVarString(
                                      out _Champion,
                                      "Trundle") &&
