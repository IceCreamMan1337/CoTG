...
class Ryze_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Ryze_Behavior_Dominion() {
        return
              // Sequence name :Ryze_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Ryze
                          (
                                SetVarString(
                                      out _Champion,
                                      "Ryze") &&
