...
class Nidalee_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Nidalee_Behavior_Dominion() {
        return
              // Sequence name :Nidalee_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Nidalee
                          (
                                SetVarString(
                                      out _Champion,
                                      "Nidalee") &&
       ...
       out _LevelUpAbilities, "LevelUp") &&
                                      SetProcedureVariable(
                                            out _MoveToCapturePointAbilities, "MoveToCapturePoint")
                                )
                          )
                    ) ||
