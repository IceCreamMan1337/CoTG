...
class KogMaw_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool KogMaw_Behavior_Dominion() {
       return
        (
              // Sequence name :KogMaw_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_KogMaw
                          (
                                SetVarString(
                                      out _Champion,
                                      "KogMaw") &&
