...
class Garen_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Garen_Behavior_Dominion() {
        return
              // Sequence name :Garen_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Garen
                          (
                                SetVarString(
                                      out _Champion,
                                      "Garen") &&
