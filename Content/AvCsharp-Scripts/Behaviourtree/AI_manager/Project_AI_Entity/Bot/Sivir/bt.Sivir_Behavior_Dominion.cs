...
class Sivir_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Sivir_Behavior_Dominion() {
        return
              // Sequence name :Sivir_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Sivir
                          (
                                SetVarString(
                                      out _Champion,
                                      "Sivir") &&
