...
class MissFortune_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool MissFortune_Behavior_Dominion() {
        return

            // Sequence name :MissFortune_Behavior_Dominion
            (
                  ...
                  (
                        ...
                        dominionInitialization.DominionInitialization(
                              ...
                              out GarrisonSlot,
                              Self) &&
                        // Sequence name :Initialization_MissFortune
                        (
                              SetVarString(
                                    out _Champion,
                                    "MissFortune") &&
                  ...
                  (
                       ...
                       dominionReferenceUpdate.DominionReferenceUpdate(
                        ...
                        targetVisibilityUpdates.TargetVisibilityUpdates(
                              ...
                              Target,
                              Self) &&
                        // Sequence name :MissFortune_Actions
                        (
