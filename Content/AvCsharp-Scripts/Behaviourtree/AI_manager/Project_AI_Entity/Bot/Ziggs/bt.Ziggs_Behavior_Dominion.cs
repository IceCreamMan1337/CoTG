...
class Ziggs_Behavior_DominionClass : AI_Characters 
{
    ...
    private ActionsDominionClass actionsDominion = new ActionsDominionClass();
      ...
      bool Ziggs_Behavior_Dominion() {
        return
              // Sequence name :Ziggs_Behavior_Dominion
              (
                    ...
                    (
                          ...
                          dominionInitialization.DominionInitialization(
                                ...
                                out GarrisonSlot,
                                Self) &&
                          // Sequence name :Initialization_Ziggs
                          (
                                SetVarString(
                                      out _Champion,
                                      "Ziggs") &&
