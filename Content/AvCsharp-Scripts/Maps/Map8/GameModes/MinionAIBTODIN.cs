...
class MinionAIBTODIN : BehaviourTree
{
    ...
    private OdinGolemBomb_SingleRunLogicClass odinGolemBomb_SingleRunLogicClass = new OdinGolemBomb_SingleRunLogicClass();
    private MinionBehaviorClass minionBehaviorClass = new MinionBehaviorClass();
    private MinionInitClass minionInitClass = new MinionInitClass();
    private OdinGolemBombLogicClass odinGolemBombLogicClass = new OdinGolemBombLogicClass();
