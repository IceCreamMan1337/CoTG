...
{
    private CapturePointCapturedAnnouncerClass capturePointCapturedAnnouncer = new CapturePointCapturedAnnouncerClass();
    private PersonalScore_CaptureClass personalScore_Capture = new PersonalScore_CaptureClass();
    private ChangeScoreFlatCapClass changeScoreFlatCap = new ChangeScoreFlatCapClass();
    private ObeliskCapturePointGoldRewardsClass obeliskCapturePointGoldRewards = new ObeliskCapturePointGoldRewardsClass();
    private PersonalScore_NeutralizeClass personalScore_Neutralize = new PersonalScore_NeutralizeClass();
    private MinionSpawnTimeSetClass minionSpawnTimeSet = new MinionSpawnTimeSetClass();
