...
class QuestObjectiveSelectorClass : OdinLayout 
{
    ...
    private QuestCapturePointChampionCountClass questCapturePointChampionCount = new QuestCapturePointChampionCountClass();
    private QuestObjectiveSelector_HelperClass questObjectiveSelector_Helper = new QuestObjectiveSelector_HelperClass();
