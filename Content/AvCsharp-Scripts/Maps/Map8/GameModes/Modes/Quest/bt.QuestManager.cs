...
{
    private CapturePointOwnerByIndexClass capturePointOwnerByIndex = new CapturePointOwnerByIndexClass();

    private ChangeScoreClass changeScore = new ChangeScoreClass();

    private PersonalScore_QuestCompleteClass personalScore_QuestComplete = new PersonalScore_QuestCompleteClass();

    private GetGuardianHasReferenceClass getGuardianHasReference = new GetGuardianHasReferenceClass();

    private CalculatePointValuesClass calculatePointValues = new CalculatePointValuesClass();

    private CountPointsClass countPoints = new CountPointsClass();

    private GetScoreFromPointDeltaClass getScoreFromPointDelta = new GetScoreFromPointDeltaClass();

    private QuestObjectiveSelectorClass questObjectiveSelector = new QuestObjectiveSelectorClass();

    private CapturePointIndexToNameClass capturePointIndexToName = new CapturePointIndexToNameClass();

    private QuestActivationClass questActivation = new QuestActivationClass();
