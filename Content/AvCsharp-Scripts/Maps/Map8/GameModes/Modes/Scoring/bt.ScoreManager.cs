...
class ScoreManagerClass : OdinLayout 
{
    ...
    private DebugSayAllClass debugSayAll = new DebugSayAllClass();
    ...
    private NexusVerticalBeamManagerClass nexusVerticalBeamManager = new NexusVerticalBeamManagerClass();
