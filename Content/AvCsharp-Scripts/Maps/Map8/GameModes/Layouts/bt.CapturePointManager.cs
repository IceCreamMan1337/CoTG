...
class CapturePointManagerClass : OdinLayout 
{
    ...
    private MinionSpawnInitializationClass minionSpawnInitialization = new MinionSpawnInitializationClass();
    private CapturePointInitializationClass capturePointInitialization = new CapturePointInitializationClass();
    private GuardianCapturePointInitializationClass guardianCapturePointInitialization = new GuardianCapturePointInitializationClass();
    private RelicInitializationClass relicInitialization = new RelicInitializationClass();
    private CenterRelicInitializationClass centerRelicInitialization = new CenterRelicInitializationClass();
    private RespawnInitializationClass respawnInitialization = new RespawnInitializationClass();
    private PersonalScore_InitializationClass personalScore_Initialization = new PersonalScore_InitializationClass();
    private SpeedShrineInitializationClass speedShrineInitialization = new SpeedShrineInitializationClass();
    private MinionGraveyardInitializationClass minionGraveyardInitialization = new MinionGraveyardInitializationClass();
    private QuestInitializationClass questInitialization = new QuestInitializationClass();
    private NexusParticleInitializationClass nexusParticleInitialization = new NexusParticleInitializationClass();
    private MinionGraveyardHelperClass minionGraveyardHelper = new MinionGraveyardHelperClass();
    private MinionSpawnManagerClass MinionSpawnManager = new MinionSpawnManagerClass();
    private ObeliskCapturePointHelperClass obeliskCapturePointHelper = new ObeliskCapturePointHelperClass();
    private PersonalScore_ManagerClass personalScore_Manager = new PersonalScore_ManagerClass();
    private RespawnManagerClass respawnManager = new RespawnManagerClass();
    private QuestManagerClass questManager = new QuestManagerClass();
    private RelicManagerClass relicManager = new RelicManagerClass();
    private CenterRelicManagerClass centerRelicManager = new CenterRelicManagerClass();
    private WinConditionCheckerClass winConditionChecker = new WinConditionCheckerClass();
    private ScoreManagerClass scoreManager = new ScoreManagerClass();
    private GetGuardianClass getGuardian = new GetGuardianClass();
    private InitializeGuardianParticlesClass initializeGuardianParticles = new InitializeGuardianParticlesClass();
      ...
      bool IsFirstBlood)
    {
        ...
        List<Func<bool>> EP_ScoreManager = new List<Func<bool>>
{ () =>
        {
        ...
        List<Func<bool>> EP_ObeliskCapturePointHelper = new List<Func<bool>>
{
       () =>
        {
            return (
        ...
        List<Func<bool>> EP_manager1 = new List<Func<bool>>
{
        () =>
        {
            return (
    ...
    List<Func<bool>> EP_manager2 = new List<Func<bool>>
{ 
        () =>
        {
            return (
    ...
    ,
        ...
        return (
                 ...
                 List <Func<bool>> EP_minionGraveyardHelper = new List<Func<bool>>
{ () =>
        {
            return (
