...
public class NeutralMinionSpawn
{
    ...
    public static void InitializeCamps()
    {
        ...
        //Blue Side Wraiths
        var blue_Wraiths = CreateJungleCamp(new Vector3 (5514.874f, 60.0f, 9323.166f), groupNumber: 1, teamSideOfTheMap: TeamId .TEAM_ORDER, campTypeIcon: "LesserCamp", 100.0f * 1000);
        ...
        //Blue Side Golems
        var blue_Golems = CreateJungleCamp(new Vector3 (4650.874f, 60.0f, 4800.0f), groupNumber: 2, teamSideOfTheMap: TeamId .TEAM_ORDER, campTypeIcon: "LesserCamp", 100.0f * 1000);
        ...
        //Blue Side Wolves
        var blue_Wolves = CreateJungleCamp(new Vector3 (4350.874f, 60.0f, 9423.166f), groupNumber: 3, teamSideOfTheMap: TeamId .TEAM_ORDER, campTypeIcon: "LesserCamp", 100.0f * 1000);
        ...
        //Red Side Wraiths
        var red_Wraiths = CreateJungleCamp(new Vector3 (7940.874f, 60.0f, 9323.166f), groupNumber: 4, teamSideOfTheMap: TeamId .TEAM_CHAOS, campTypeIcon: "LesserCamp", 100.0f * 1000);
        ...
        //Red Side Golems
        var red_Golems = CreateJungleCamp(new Vector3 (8650.874f, 60.0f, 4800.0f), groupNumber: 5, teamSideOfTheMap: TeamId .TEAM_CHAOS, campTypeIcon: "LesserCamp", 100.0f * 1000);
        ...
        //Red Side Wolves
        var red_Wolves = CreateJungleCamp(new Vector3 (9200.874f, 60.0f, 9423.166f), groupNumber: 6, teamSideOfTheMap: TeamId .TEAM_CHAOS, campTypeIcon: "LesserCamp", 100.0f * 1000);
