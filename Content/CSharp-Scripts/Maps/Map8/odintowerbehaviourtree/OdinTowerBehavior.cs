...
class OdinTowerBehaviorClass : OdinLayout
{
    ...
    private OdinTower_CheckForChampionsClass_forscript odinTower_CheckForChampions = new();
    private OdinTowerCanCastAbility0Class odinTowerCanCastAbility0 = new();
    private OdinTowerCastAbility0Class odinTowerCastAbility0 = new();
