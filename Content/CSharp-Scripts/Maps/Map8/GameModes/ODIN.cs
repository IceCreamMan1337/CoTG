...
public class ODIN : DefaultGamemode
{
    ...
    private OdinOpeningCeremonyClass_forscript odinOpeningCeremonyClass_forscript = new();
    private OdinOpeningCeremonyClass odinOpeningCeremony = new();
    private LevelPropAnimationsClass levelPropAnimations = new();
    private CapturePointManagerClass capturePointManager = new();
    private ThresholdAnnouncementsClass ThresholdAnnouncements = new();
    private EndOfGameCeremonyClass_forscript EndOfGameCeremony = new();
    private CapturePointManagerClass_script capturePointManagerClass_script = new();
