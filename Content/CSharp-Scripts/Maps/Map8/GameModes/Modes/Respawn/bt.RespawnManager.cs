...
{
    private GetRespawnAdjustments_NexusHealthClass getRespawnAdjustments_NexusHealth = new();

    private GetRespawnAdjustments_DisconnectClass getRespawnAdjustments_Disconnect = new();

    private RespawnHelperClass respawnHelper = new();

    private RespawnWindowAdjustment_DisconnectClass respawnWindowAdjustment_Disconnect = new();
