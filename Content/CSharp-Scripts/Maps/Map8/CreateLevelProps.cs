...
public static class CreateLevelProps
{
    ...
    public static void CreateProps()
    {
        ...
        /* SwainBeams[0] =*/
        AddLevelProp("LevelProp_SwainBeam1", "SwainBeam", new Vector3(7207.073f, 461.54602f, 1995.804f), Vector3.Zero, new Vector3(-422.2222f, 355.5555f, -311.1111f), Vector3.One);
        /* SwainBeams[1] =*/
        AddLevelProp("LevelProp_SwainBeam2", "SwainBeam", new Vector3(8142.406f, 639.324f, 2716.4258f), new Vector3(0.0f, 152.0f, 0.0f), new Vector3(-222.2222f, 444.4445f, -88.8889f), Vector3.One);
        /* SwainBeams[2] =*/
        AddLevelProp("LevelProp_SwainBeam3", "SwainBeam", new Vector3(9885.076f, 350.435f, 3339.1853f), new Vector3(0.0f, 54.0f, 0.0f), new Vector3(144.4445f, 300.0f, -155.5555f), Vector3.One);
        /* Stairs[1] =*/
        AddLevelProp("LevelProp_Odin_SoG_Chaos", "Odin_SoG_Chaos", new Vector3(13623.644f, 117.7046f, 3884.6233f), Vector3.Zero, new Vector3(288.8889f, 111.1112f, -211.1111f), Vector3.One);
        ...
        OrderCrystal = AddLevelProp("LevelProp_Odin_SOG_Order_Crystal", "Odin_SOG_Order_Crystal", new Vector3(1689.68f, -81.599f, 4414.49f), Vector3.Zero, new Vector3(-122.2222f, 277.7778f, -122.2222f), Vector3.One);
        ChaosCrystal = AddLevelProp("LevelProp_Odin_SOG_Chaos_Crystal", "Odin_SOG_Chaos_Crystal", new Vector3(12307.629f, 225.8346f, 4535.6484f), Vector3.Zero, new Vector3(144.4445f, 222.2222f, -33.3334f), Vector3.One);
        //new Vector3 (0.0f, 214.0f, 0.0f)
    ...
    /*internal static void StairAnimation(stringanimationName, float time = 20)
    {
        foreach (var stair in Stairs)
        {
