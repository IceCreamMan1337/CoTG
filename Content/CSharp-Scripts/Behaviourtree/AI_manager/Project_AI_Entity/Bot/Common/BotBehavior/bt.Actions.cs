...
{
    private HighThreatManagementClass highThreatManagement = new();
    private SummonerClarityClass summonerClarity = new();
    private GlobalClass global = new();
    private HealClass heal = new();
    private SummonerCleanseClass summonerCleanse = new();
    private KillChampionClass killChampion = new();
    private HelpKillChampionClass helpKillChampion = new();
    private LowThreatClass lowThreat = new();
    private ReturnToBaseClass returnToBase = new();
    private AttackClass attack = new();
    private PushLaneClass pushLane = new();
