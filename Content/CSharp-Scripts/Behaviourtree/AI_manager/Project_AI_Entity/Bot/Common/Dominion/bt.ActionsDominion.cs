...
{
    private SummonerClarityClass summonerClarity = new();
    private DominionGlobalClass dominionGlobal = new();
    private DominionHealClass dominionHeal = new();
    private SummonerCleanseClass summonerCleanse = new();
    private DominionNinjaCapturePointClass dominionNinjaCapturePoint = new();
    private SuppressCapturePointClass suppressCapturePoint = new();
    private InterruptCaptureClass interruptCapture = new();
    private SummonerGarrisonClass summonerGarrison = new();
    private DominionKillChampionClass dominionKillChampion = new();
    private DominionHighThreatClass dominionHighThreat = new();
    private DominionLowThreatClass dominionLowThreat = new();
    private DominionReturnToBaseClass dominionReturnToBase = new();
    private DominionHelpKillChampionClass dominionHelpKillChampion = new();
    private DominionMidThreatClass dominionMidThreat = new();
    private CapturePointClass capturePoint = new();
    private DominionAttackClass dominionAttack = new();
    private DominionRetreatFromEnemyCapturePointClass dominionRetreatFromEnemyCapturePoint = new();
    private WanderClass wander = new();
    private MoveToCapturePointClass moveToCapturePoint = new();
    private PostActionAndDebugClass postActionAndDebug = new();
    private IssueEventClass issueEvent = new();
