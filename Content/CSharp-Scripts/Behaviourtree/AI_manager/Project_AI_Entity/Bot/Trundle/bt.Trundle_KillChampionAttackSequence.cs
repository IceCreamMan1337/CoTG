...
class Trundle_KillChampionAttackSequenceClass : AI_Characters
{
    ...
    public bool Trundle_KillChampionAttackSequence(
         ...
         )
    {
        ...
        bool result =
                  // Sequence name :TrundleKillChampion
