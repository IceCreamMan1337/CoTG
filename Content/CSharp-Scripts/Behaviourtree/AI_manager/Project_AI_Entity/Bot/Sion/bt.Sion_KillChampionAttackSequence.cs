...
class Sion_KillChampionAttackSequenceClass : AI_Characters
{
    ...
    public bool Sion_KillChampionAttackSequence(
         ...
         )
    {
        ...
        bool result =
                  // Sequence name :SionKillChampion
