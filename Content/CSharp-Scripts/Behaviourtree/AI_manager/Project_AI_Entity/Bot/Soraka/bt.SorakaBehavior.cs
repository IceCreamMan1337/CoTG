...
class SorakaBehaviorClass : AI_Characters
{
        ...
        return
                  ...
                  (
                        ...
                        targetVisibilityUpdates.TargetVisibilityUpdates(
                              ...
                              Target,
                              Self)
                        && DebugAction("TargetVisibilityUpdates passed , now PassiveActions ")
                        &&
                ...
                (actions.Actions(
                       ...
                       ValueOfAbility3,
                        ...
                        ActionDebugText,
                        TaskDebugText)
                 && DebugAction(" Actions , everything is passed in BT "))
                )
            )
