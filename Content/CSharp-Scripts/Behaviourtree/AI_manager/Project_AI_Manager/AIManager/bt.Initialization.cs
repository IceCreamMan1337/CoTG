...
class InitializationClass : CommonAI
{
     ...
     out bool OverrideDifficulty)
    {
        ...
        bool result =
                  ...
                  (
                        DebugAction("InitializationClass: GetGameTime") &&
                        GetGameTime(
                              out _StartGameTime) &&
                         ...
                         &&
                              ...
                              SetVarFloat(
                                    out _PrevLaneDistributionTime,
                                    0) &&
                              SetVarFloat(
                                    out _PointValue_Champion,
                                    100) &&
                              SetVarFloat(
                                    out _PointValue_Minion,
                                    20) &&
                              SetVarInt(
                                    out _DistributionCount,
                                    0) &&
                              SetVarFloat(
                                    out _DynamicDistributionStartTime,
                                    540) &&
                              SetVarFloat(
                                    out _DynamicDistributionUpdateTime,
                                    15)
                         &&
