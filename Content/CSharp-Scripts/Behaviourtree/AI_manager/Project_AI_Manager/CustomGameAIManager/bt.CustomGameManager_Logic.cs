...
{
    private InitializationcustomgameClass initializationcustomgame = new();
    private WinLossStateClass winLossState = new();
    private BeginnerOverrideDifficulty_TurretDestructionClass beginnerOverrideDifficulty_TurretDestruction = new();
    private DifficultySettingClass difficultySetting = new();
    private ReferenceUpdateGlobalClass referenceUpdateGlobal = new();
    private LevelNormalizerClass levelNormalizer = new();
    private DisconnectAdjustmentManagerClass disconnectAdjustmentManager = new();
    private Lane_OptimalDistributionClass lane_OptimalDistribution = new();
    private StaticLaneDistributionClass staticLaneDistribution = new();
    private AssignToLaneClass assignToLane = new();
    private ConformLanesToPlayersClass conformLanesToPlayers = new();
    private CustomGameStaticLaneDistributionClass customGameStaticLaneDistribution = new(); public bool CustomGameManager_Logic()
    {
