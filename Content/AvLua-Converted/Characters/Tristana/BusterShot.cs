namespace Spells
{
    public class BusterShot : SpellScript
    {
        ...
        private readonly int[] knockBackDistances = { 600, 800, 1000 };
        private readonly int[] damageAmounts = { 300, 400, 500 };
        ...
        {
            float knockBackDistance = knockBackDistances[level - 1];
            ...
            ))
            {
                ...
                AddBuff(attacker, unit, new Buffs.BusterShot(knockBackDistance), 1, 1, 0.5f, BuffAddType.REPLACE_EXISTING, BuffType.STUN, 0, true, false, false);
            }

            ApplyDamage(attacker, target, damageAmounts[level - 1], DamageType.DAMAGE_TYPE_MAGICAL, DamageSource.DAMAGE_SOURCE_SPELL, 1, 1.5f, 1, false, false, attacker);
        }
    }
}
...
namespace Buffs
{
    public class BusterShot : BuffScript
    {
        ...
        {
            DisableOwnerActions();
            float distance = DistanceBetweenObjects(owner, attacker) + knockBackDistance;
        ...
        private void DisableOwnerActions()
        {
        ...
        private void EnableOwnerActions()
        {
