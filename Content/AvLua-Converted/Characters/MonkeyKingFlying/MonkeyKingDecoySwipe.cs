...
namespace Spells
{
    public class MonkeyKingDecoySwipe : SpellScript
    {
            ...
            ref HitResult hitResult)
        {
            ...
            int number = GetUnitsInArea((ObjAIBase)owner, owner.Position3D, 300, SpellDataFlags.AffectEnemies | SpellDataFlags.AffectNeutral | SpellDataFlags.AffectMinions | SpellDataFlags.AffectHeroes, default, true).Count();
