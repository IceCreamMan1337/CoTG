    ...
    public class KogMawVoidOozeMissile : SpellScript
    {
        ...
        public override void TargetExecute(AttackableUnit target, SpellMissile missileNetworkID,ref HitResult hitResult)
        {
            if(owner.Team != target.Team)
            {
                ...
                SpellEffectCreate(out _, out _, "KogMawVoidOoze_tar.troy", default, target.Team, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, target, default, default, target, default, default, true, default, default, false, false);
            }
        }
