    ...
    public class CharScriptAkali : CharScript
    {
        ...
        public override void OnUpdateActions()
        {
            if (ExecutePeriodically(1, ref lastTime2Executed, true))
            {
                ...
                if (GetBuffCountFromCaster(owner, owner, nameof(Buffs.AkaliShadowDance)) == 0 && levelrealofulti > 0)
                {
                    AddBuff(owner, owner, new Buffs.AkaliShadowDance(), 4, 2, 25, BuffAddType.STACKS_AND_CONTINUE, BuffType.COUNTER, 0, true, false, false);
                }
                //
            }
        }
