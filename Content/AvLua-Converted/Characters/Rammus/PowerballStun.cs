namespace Buffs
{
    public class PowerballStun : BuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            dist += 225;
            //was 10 gravity // 200 speed
            MoveAway(owner, attacker.Position3D, 400, 5, dist, 0, ForceMovementType.FURTHEST_WITHIN_RANGE, ForceMovementOrdersType.CANCEL_ORDER, 100);
