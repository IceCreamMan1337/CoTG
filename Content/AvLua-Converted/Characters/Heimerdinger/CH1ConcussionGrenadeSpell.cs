namespace Spells
{
    public class HeimerdingerESpell: CH1ConcussionGrenadeSpell {}
    public class CH1ConcussionGrenadeSpell : SpellScript
    {
...
namespace Buffs
{
    public class CH1ConcussionGrenadeSpell : BuffScript
    {
