namespace Buffs
{
    public class YorickDeathGripBeamDelay : BuffScript
    {
        int durationLevel;
        Particle particle;
        Particle particle1;
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out particleID6, out _, "YorickPHWallBlue.troy", default, teamOfOwner, 200, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "bottom", default, attacker, "bottom", default, false, default, default, false, false);
        }
        public override void OnDeactivate(bool expired)
        {
            ...
            float durationLevel = this.durationLevel;
