namespace Buffs
{
    public class PoppyHeroicChargePart2 : BuffScript
    {
        ...
        bool hasDoneSecondaryDamage; // Protection against multiple damage applications
        ...
        public PoppyHeroicChargePart2(float slashSpeed = default, Vector3 newTargetPos = default, float damageTwo = default)
        {
            ...
            this.hasDoneSecondaryDamage = false;
        }
        ...
        {
            // Prevent multiple damage applications from the same buff
            if (hasDoneSecondaryDamage)
            {
                return;
            }
            ...
            {
                hasDoneSecondaryDamage = true; // Mark that we've done damage
                if (owner != caster)
                {
