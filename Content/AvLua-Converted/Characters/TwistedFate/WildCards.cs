namespace Spells
{
    public class WildCards : SpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            Vector3 pos = GetPointByUnitFacingOffsetposition(owner, targetpos, 30, 0);
            //  Vector3 pos1 = GetPointByUnitFacingOffset(owner, 1000, 0);
            Vector3 pos1 = GetPointByUnitFacingOffsetposition(owner, targetpos, 1000, 0);

            Minion other1 = SpawnMinion("TestCube", "TestCubeRender", "idle.lua", pos, teamID, false, false, false, true, false, true, 0, false, false, (Champion)owner);
            //  Minion other1 = SpawnMinion("PlagueBlock", "TrundleWall", "idle.lua", pos, teamID, true, true, true, true, false, true, 0, false, false, (Champion)owner);
           // FaceDirection(other1, GetCastSpellTargetPos());

           // Vector3 pos2 = GetPointByUnitFacingOffset(owner, 1000, -28);

            Vector3 pos2 = GetPointByUnitFacingOffsetposition(owner, targetpos, 1000, -28);

           // Vector3 pos3 = GetPointByUnitFacingOffset(owner, 1000, 28);

            Vector3 pos3 = GetPointByUnitFacingOffsetposition(owner, targetpos, 1000, 28);
            SetSpell(owner, 0, SpellSlotType.ExtraSlots, SpellbookType.SPELLBOOK_CHAMPION, nameof(Spells.SealFateMissile));

            SpellCast(owner, default, pos1, pos1, 0, SpellSlotType.ExtraSlots, level, true, true, false, false, false, false);
            SetSpell(owner, 0, SpellSlotType.ExtraSlots, SpellbookType.SPELLBOOK_CHAMPION, nameof(Spells.SealFateMissile));
            SpellCast(owner, default, pos2, pos2, 0, SpellSlotType.ExtraSlots, level, true, true, false, false, false, false);
            SetSpell(owner, 0, SpellSlotType.ExtraSlots, SpellbookType.SPELLBOOK_CHAMPION, nameof(Spells.SealFateMissile));
            SpellCast(owner, default, pos3, pos3, 0, SpellSlotType.ExtraSlots, level, true, true, false, false, false, false);
