...
namespace Spells
{
    public class Pantheon_Heartseeker : SpellScript
    {
        ...
        public override void ChannelingStart()
        {
            ...
            AddBuff((ObjAIBase)owner, owner, new Buffs.Pantheon_Heartseeker(castPosition, sourcePosition), 1, 1, 0.75f, BuffAddType.REPLACE_EXISTING, BuffType.INTERNAL, 0.25f, true, false, false);
