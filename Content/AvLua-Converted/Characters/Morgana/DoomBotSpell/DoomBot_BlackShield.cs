namespace Spells
{
    public class DoomBot_BlackShield : SpellScript
    {
            ...
            ref HitResult hitResult)
        {
            ...
            AddBuff(attacker, target, new Buffs.DoomBot_BlackShield(nextBuffVars_ShieldHealth), 1, 1, effect1[level - 1], BuffAddType.RENEW_EXISTING, BuffType.SPELL_IMMUNITY, 0, true, false, false);
            foreach (AttackableUnit unit in GetUnitsInArea(owner, owner.Position3D, 800, SpellDataFlags.AffectFriends  | SpellDataFlags.AffectMinions | SpellDataFlags.AffectHeroes, "", false))
            {
                AddBuff(attacker, unit, new Buffs.DoomBot_BlackShield(nextBuffVars_ShieldHealth), 1, 1, effect1[level - 1], BuffAddType.RENEW_EXISTING, BuffType.SPELL_IMMUNITY, 0, true, false, false);
            }
...
namespace Buffs
{
    public class DoomBot_BlackShield : BuffScript
    {
        ...
        public DoomBot_BlackShield(float shieldHealth = default)
        {
