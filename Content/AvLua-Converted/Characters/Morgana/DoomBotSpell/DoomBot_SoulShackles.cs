namespace Spells
{
    public class DoomBot_SoulShackles : SpellScript
    {
        ...
        {
            AddBuff(owner, owner, new Buffs.SoulShacklesOwner(), 1, 1, 0.5f, BuffAddType.REPLACE_EXISTING, BuffType.INTERNAL, 0, true, false, false);
        }
            ...
            ref HitResult hitResult)
        {
            ...
            AddBuff(attacker, target, new Buffs.DoomBot_SoulShackles(nextBuffVars_BreakDamage, nextBuffVars_BreakStun, nextBuffVars_Broken), 1, 1, 3, BuffAddType.REPLACE_EXISTING, BuffType.COMBAT_DEHANCER, 0, true, false, false);
...
namespace Buffs
{
    public class DoomBot_SoulShackles : BuffScript
    {
        ...
        public DoomBot_SoulShackles(float breakDamage = default, float breakStun = default, bool broken = default)
        {
            ...
            if (ExecutePeriodically(0.5f, ref lastTimeExecuted, true))
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (distance > 600)
                        {
                            DebugSay(attacker, "broken distance due = true");
                            broken = true;
                            SpellBuffRemove(owner, nameof(Buffs.SoulShackleSlow), attacker, 0);
                            SpellBuffRemoveCurrent(owner);
                        }
