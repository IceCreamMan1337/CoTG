namespace Buffs
{
    public class DesperatePower_marker : BuffScript
    {
        ...
        private readonly int[] tooltipAmountsByLevel = { 40, 40, 40, 40, 40, 40, 80, 80, 80, 80, 80, 80, 120, 120, 120, 120, 120, 120 };
        ...
        public override void OnUpdateActions()
        {
            if (ExecutePeriodically(10, ref lastTimeExecuted, true))
            {
                ...
                float tooltipAmount = tooltipAmountsByLevel[level - 1];
