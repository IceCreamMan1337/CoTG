namespace Buffs
{
    public class OrianaGhost : BuffScript
    {
        ...
        public override void OnUpdateActions()
        {
            ...
            else if (distance <= 75) //Should be 25, but increased to 75 because the ball slightly blocks the movement and makes it really awkward to pick up the ball otherwise
            {
