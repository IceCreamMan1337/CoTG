namespace Buffs
{
    public class ActionTimer : BuffScript
    {
        ...
        public override void OnDeactivate(bool expired)
        {
            ...
            foreach (AttackableUnit unit in GetClosestUnitsInArea(owner, owner.Position3D, 900, SpellDataFlags.AffectEnemies | SpellDataFlags.AffectHeroes, 1, nameof(Buffs.Stealth), false))
            {
                ...
                {
                    AddBuff(attacker, target, new Buffs.ActionTimer2(), 1, 1, 0.5f, BuffAddType.REPLACE_EXISTING, BuffType.INTERNAL, 0, true, false);
                }
            }
            if (!foundUnit)
            {
...
namespace PreLoads
{
    public class ActionTimer : IPreLoadScript
    {
        public void Preload()
        {
