namespace Buffs
{
    public class OdinSpeedShrineAura : BuffScript
    {
        ...
        public override void OnUpdateActions()
        {
            ...
            {
                foreach (AttackableUnit unit in GetUnitsInArea((ObjAIBase)owner, owner.Position3D, 365, SpellDataFlags.AffectAllSides | SpellDataFlags.AffectAllUnitTypes))//SpellDataFlags.AffectHeroes))//, default, true))
                {
