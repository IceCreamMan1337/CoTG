namespace Buffs
{
    public class OdinBombSuccessParticle : BuffScript
    {
        float startTime;
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out _, out _, "OdinBombSuccessParticle", default, TeamId.TEAM_UNKNOWN, 0, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, owner, default, default, false, false, false, false, false);
        }
