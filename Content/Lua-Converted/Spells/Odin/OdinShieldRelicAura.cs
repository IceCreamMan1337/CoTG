namespace Buffs
{
    public class OdinShieldRelicAura : BuffScript
    {
        ...
        public override void OnUpdateActions()
        {
            ...
            {
                foreach (AttackableUnit unit in GetClosestUnitsInArea(owner, owner.Position3D, 175, SpellDataFlags.AffectAllSides | SpellDataFlags.AffectAllUnitTypes, 1))//SpellDataFlags.AffectHeroes, 1, default, true))
                {
                    if (!killMe)
                    {
