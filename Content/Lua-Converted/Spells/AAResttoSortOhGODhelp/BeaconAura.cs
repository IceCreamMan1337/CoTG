namespace Buffs
{
    public class BeaconAura : BuffScript
    {
        ...
        public override void OnUpdateActions()
        {
            ...
            {
                //AddBuffToEachUnitInArea(owner, owner.Position3D, 850, SpellDataFlags.AffectFriends | SpellDataFlags.AffectMinions | SpellDataFlags.AffectHeroes | SpellDataFlags.NotAffectSelf, attacker, new Buffs.BeaconAuraNoParticle(), BuffAddType.RENEW_EXISTING, BuffType.AURA, 1, 1, 1.1f, 0, false, true);
                ...
                {
                    AddBuff(attacker, unit, new Buffs.BeaconAuraNoParticle(), 1, 1, 1.1f, BuffAddType.RENEW_EXISTING, BuffType.AURA, 0, default, default, false);
                }
            }
        }
    }
...
namespace PreLoads
{
    public class BeaconAura : IPreLoadScript
    {
        public void Preload()
        {
