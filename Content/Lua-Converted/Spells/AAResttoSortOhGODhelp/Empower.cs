namespace Spells
{
    public class Empower : SpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            AddBuff(owner, owner, new Buffs.Empower(nextBuffVars_DamagePerStack), 1, 1, 8, BuffAddType.RENEW_EXISTING, BuffType.INTERNAL, 0, true, false, false);
        }
    }
}
namespace Buffs
{
    public class Empower : BuffScript
    {
        ...
        public Empower(float damagePerStack = default)
        {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out particle, out _, "Empower_buf.troy", default, TeamId.TEAM_UNKNOWN, 0, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "weaponstreak", default, owner, default, default, false, default, default, false);
        ...
        public override void OnUpdateActions()
        {
            ...
            {
                AddBuff((ObjAIBase)owner, owner, new Buffs.EmpowerCleave(), 3, 1, 1, BuffAddType.STACKS_AND_RENEWS, BuffType.COMBAT_ENCHANCER, 0, true, false, false);
            }
        }
            ...
            DamageSource damageSource, ref HitResult hitResult)
        {
            ...
            SpellBuffRemove(owner, nameof(Buffs.Empower), (ObjAIBase)owner, 0);
            SpellBuffRemoveStacks(owner, (ObjAIBase)owner, nameof(Buffs.EmpowerCleave), 0);
        }
    }
}
namespace PreLoads
