namespace Buffs
{
    public class WillRevive : BuffScript
    {
        ...
        public override void OnUpdateStats()
        {
            ...
            if (name == nameof(GuardianAngel))
            {
                guardianAngelCount++;
            }
            if (name1 == nameof(GuardianAngel))
            {
                guardianAngelCount++;
            }
            if (name2 == nameof(GuardianAngel))
            {
                guardianAngelCount++;
            }
            if (name3 == nameof(GuardianAngel))
            {
                guardianAngelCount++;
            }
            if (name4 == nameof(GuardianAngel))
            {
                guardianAngelCount++;
            }
            if (name5 == nameof(GuardianAngel))
            {
                guardianAngelCount++;
            }
