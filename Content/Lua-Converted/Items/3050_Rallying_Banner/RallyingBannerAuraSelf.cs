namespace Buffs
{
    public class RallyingBannerAuraSelf : BuffScript
    {
        ...
        public RallyingBannerAuraSelf(float lifeStealMod = default, float attackSpeedMod = default, float healthRegenMod = default)
        {
