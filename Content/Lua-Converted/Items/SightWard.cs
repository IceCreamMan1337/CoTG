namespace Spells
{
    public class SightWard : SpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            Minion other3 = SpawnMinion("SightWard", "SightWard", "idle.lua", targetPos, teamID, true, true, false, false, false, false, 0, true, false, (Champion)owner);
...
namespace Buffs
{
    public class SightWard : BuffScript
    {
        ...
        {
            if (damageAmount >= 1 && attacker is not LaneTurret)
            {
...
namespace PreLoads
{
    public class SightWard : IPreLoadScript
    {
        public void Preload()
        {
