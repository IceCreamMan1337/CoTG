namespace Spells
{
    public class MissileBarrageMissile : SpellScript
    {
            ...
            ref HitResult hitResult)
        {
            ...
            if (!isStealthed)
            {
                SpellEffectCreate(out _, out _, "corki_MissleBarrage_std_tar.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, target, "spine", target.Position3D, target, default, default, true, default, default, false, false);
...
namespace PreLoads
{
    public class MissileBarrageMissile : IPreLoadScript
    {
        public void Preload()
        {
