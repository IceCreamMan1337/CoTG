namespace Spells
{
    public class BrandWildfireMissile : SpellScript
    {
                    ...
                    if (!doOnce)
                    {
                        if (unit != target)
                        {
                            ...
                            if (!isStealthed)
                            {
                                ...
                                {
                                    SpellCast(attacker, unit, default, default, 4, SpellSlotType.ExtraSlots, level, true, true, false, true, false, true, attackerPos);
                                }
                                else
                                {
                                    SpellCast(attacker, unit, default, default, 1, SpellSlotType.ExtraSlots, level, true, true, false, true, false, true, attackerPos);
                                }
                                doOnce = true;
                            }
                            else
...
namespace Buffs
{
    public class BrandWildfireMissile : BuffScript
    {
...
namespace PreLoads
{
    public class BrandWildfireMissile : IPreLoadScript
    {
        public void Preload()
        {
