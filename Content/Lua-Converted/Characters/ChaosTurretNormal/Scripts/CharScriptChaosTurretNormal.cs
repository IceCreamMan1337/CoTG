...
{
    public class CharScriptChaosTurretNormal : CharScript
    {
        public override void OnActivate()
        {
            AddBuff(owner, owner, new Buffs.TurretBonus(), 1, 1, 2280.1f, BuffAddType.RENEW_EXISTING, BuffType.AURA, 60);
            float nextBuffVars_BonusHealth = 125;
            float nextBuffVars_BubbleSize = 1000;
...
namespace PreLoads
{
    public class CharScriptChaosTurretNormal : IPreLoadScript
    {
        public void Preload()
        {
