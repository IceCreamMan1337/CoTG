namespace Spells
{
    public class RenektonDice : SpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            int nextBuffVars_BonusDamage = effect1[level - 1];
...
namespace Buffs
{
    public class RenektonDice : BuffScript
    {
        ...
        int level; // UNUSED
        public RenektonDice(float bonusDamage = default, bool diceVersion = default, float armorShred = default, float dashSpeed = default, Vector3 targetPos = default, float distance = default)
        {
...
namespace PreLoads
{
    public class RenektonDice : IPreLoadScript
    {
        public void Preload()
        {
