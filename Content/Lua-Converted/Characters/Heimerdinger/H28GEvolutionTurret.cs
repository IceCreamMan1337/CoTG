namespace Spells
{
    ...
    public class H28GEvolutionTurret : SpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            //hack for the count
            level = GetSlotSpellLevel(owner, 0, SpellbookType.SPELLBOOK_CHAMPION, SpellSlotType.UseSpellSlot);
            ...
            //hack for the levelup
            var level2 = GetSlotSpellLevel(owner, 0, SpellbookType.SPELLBOOK_CHAMPION, SpellSlotType.UseSpellSlot);

            if (GetBuffCountFromCaster(owner, owner, nameof(Buffs.UpgradeBuff)) > 0)
            {

                other3 = SpawnMinion("H-28G Evolution Turret", "HeimerTBlue", "turret.lua", targetPos, teamID, false, false, true, false, false, false, 0, false, false, (Champion)owner);
                //hack , turret seem moving client side ( was not the case on server ) 
                SetCanMove(other3, false);
            ...
            else if (level2 == 5)
            {
                ...
                other3 = SpawnMinion("H-28G Evolution Turret", "HeimerTRed", "turret.lua", targetPos, teamID, false, false, true, false, false, false, 0, false, false, (Champion)owner);
                //hack , turret seem moving client side ( was not the case on server ) 
                SetCanMove(other3, false);
            ...
            else if (level2 >= 2)
            {
                ...
                other3 = SpawnMinion("H-28G Evolution Turret", "HeimerTGreen", "turret.lua", targetPos, teamID, false, false, true, false, false, false, 0, false, false, (Champion)owner);
                //hack , turret seem moving client side ( was not the case on server ) 
                SetCanMove(other3, false);
            ...
            {
                other3 = SpawnMinion("H-28G Evolution Turret", "HeimerTYellow", "turret.lua", targetPos, teamID, false, false, true, false, false, false, 0, false, false, (Champion)owner);
                //hack , turret seem moving client side ( was not the case on server ) 
                SetCanMove(other3, false);
            }
            AddBuff(owner, other3, new Buffs.UPGRADEùùùProof(), 1, 1, 6, BuffAddType.RENEW_EXISTING, BuffType.COMBAT_ENCHANCER, 0, true, false, false);
