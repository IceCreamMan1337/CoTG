namespace Spells
{
    public class H28GEvolutionTurretSpell1 : SpellScript
    {
...
namespace Buffs
{
    public class H28GEvolutionTurretSpell1 : BuffScript
    {
...
namespace PreLoads
{
    public class H28GEvolutionTurretSpell1 : IPreLoadScript
    {
        public void Preload()
        {
            PreloadSpell("taunt");
