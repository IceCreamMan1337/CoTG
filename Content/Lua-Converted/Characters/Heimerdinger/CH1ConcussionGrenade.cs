namespace Spells
{
    ...
    public class CH1ConcussionGrenade : SpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            SetSpell(owner, 0, SpellSlotType.ExtraSlots, SpellbookType.SPELLBOOK_CHAMPION, nameof(Spells.CH1ConcussionGrenadeSpell));
            SetSpell(owner, 3, SpellSlotType.ExtraSlots, SpellbookType.SPELLBOOK_CHAMPION, nameof(Spells.CH1ConcussionGrenadeUpgrade));
