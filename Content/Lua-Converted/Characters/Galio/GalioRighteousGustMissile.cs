...
namespace Buffs
{
    public class GalioRighteousGustMissile : BuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out windVFXAlly, out windVFXEnemy, "galio_windTunnel_rune.troy", "galio_windTunnel_rune_team_red.troy", teamID, 240, 0, TeamId.TEAM_UNKNOWN,
                default, default, false, default, "head", owner.Position3D, owner, default, default, false, default, default, false, false, orientationPoint);
