    ...
    public class OrianaIzunaCommand : SpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            if (shiftWithoutMissile)
            {
                ...
                Minion other3 = SpawnMinion("TheDoomBall", "OriannaBall", "idle.lua", targetPos, teamID, false, true, false, true, false, true, 0, default, true, (Champion)owner);
...
namespace PreLoads
{
    public class OrianaIzunaCommand : IPreLoadScript
    {
        public void Preload()
        {
