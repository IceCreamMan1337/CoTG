    ...
    public class OrianaIzuna : SpellScript
    {
        ...
        public override void OnMissileEnd(string spellName, Vector3 missileEndPosition)
        {
            ...
            if (duration >= 0.001f && correctSpell)
            {
                ...
                Minion other3 = SpawnMinion("TheDoomBall", "OriannaBall", "idle.lua", missileEndPosition, teamID, false, true, false, true, false, true, 0, false, true, (Champion)owner);
...
namespace PreLoads
{
    public class OrianaIzuna : IPreLoadScript
    {
        public void Preload()
        {
