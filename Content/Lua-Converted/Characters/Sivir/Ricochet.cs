...
namespace Spells
{
    public class Ricochet : SpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            {
                SpellBuffRemove(owner, nameof(Buffs.Ricochet), owner);
            }
            else
            {
                nextBuffVars_LastLevel = level;
                AddBuff(owner, owner, new Buffs.Ricochet(nextBuffVars_LastLevel), 1, 1, 25000, BuffAddType.REPLACE_EXISTING, BuffType.AURA, 0);
            }
        }
    }
}
