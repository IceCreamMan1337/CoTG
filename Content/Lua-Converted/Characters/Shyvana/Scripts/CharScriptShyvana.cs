namespace CharScripts
{
    public class CharScriptShyvana : CharScript
    {
        ...
        {
            if (target is ObjAIBase && target is not LaneTurret && GetBuffCountFromCaster(owner, owner, nameof(Buffs.ShyvanaDoubleAttack)) == 0 && GetBuffCountFromCaster(owner, owner, nameof(Buffs.ShyvanaDoubleAttackDragon)) == 0)
            {
