namespace Spells
{
    public class HowlingGaleSpell : SpellScript
    {
            ...
            ref HitResult hitResult)
        {
            ...
            if (owner.Team != target.Team)
            {
                if (!isStealthed)
                {
                    ...
                    AddBuff(owner, target, new Buffs.Move(nextBuffVars_Speed, nextBuffVars_Gravity, nextBuffVars_Position, nextBuffVars_IdealDistance), 1, 1, 0.5f, BuffAddType.REPLACE_EXISTING, BuffType.STUN, 0, true, false, false);
                }
                else
                {
...
namespace Buffs
{
    public class HowlingGaleSpell : BuffScript
    {
...
namespace PreLoads
{
    public class HowlingGaleSpell : IPreLoadScript
    {
        public void Preload()
        {
            PreloadSpell("move");
