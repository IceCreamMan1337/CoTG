namespace Spells
{
    public class XerathArcanopulsePartFix2 : SpellScript
    {
...
namespace Buffs
{
    public class XerathArcanopulsePartFix2 : BuffScript
    {
        public override void OnActivate()
        {
            Vector3 ownerPos = GetUnitPosition(owner); // UNUSED
            TeamId teamID = GetTeamID_CS(owner);
            Vector3 beam1 = GetPointByUnitFacingOffset(owner, 400, 0);
            Vector3 beam2 = GetPointByUnitFacingOffset(owner, 600, 0);
            Vector3 beam3 = GetPointByUnitFacingOffset(owner, 800, 0);
...
namespace PreLoads
{
    public class XerathArcanopulsePartFix2 : IPreLoadScript
    {
        public void Preload()
        {
