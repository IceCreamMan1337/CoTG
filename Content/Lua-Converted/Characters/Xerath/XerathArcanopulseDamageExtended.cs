namespace Spells
{
    public class XerathArcanopulseDamageExtended : SpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            Vector3 beam3 = GetPointByUnitFacingOffset(owner, 1600, 0);
            ...
            AddBuff(attacker, other1, new Buffs.XerathArcanopulseDeath(), 1, 1, 1.5f, BuffAddType.REPLACE_EXISTING, BuffType.INTERNAL, 0, true, false, false);
            AddBuff(attacker, other3, new Buffs.XerathArcanopulseDeath(), 1, 1, 1.5f, BuffAddType.REPLACE_EXISTING, BuffType.INTERNAL, 0, true, false, false);
            AddBuff(attacker, other1, new Buffs.ExpirationTimer(), 1, 1, 1.5f, BuffAddType.REPLACE_EXISTING, BuffType.INTERNAL, 0, true, false, false);
            AddBuff(attacker, other3, new Buffs.ExpirationTimer(), 1, 1, 1.5f, BuffAddType.REPLACE_EXISTING, BuffType.INTERNAL, 0, true, false, false);
            ...
            Vector3 damagePoint = GetPointByUnitFacingOffset(owner, 800, 0);
            foreach (AttackableUnit unit in GetUnitsInRectangle(owner, damagePoint, 95, 800, SpellDataFlags.AffectEnemies | SpellDataFlags.AffectNeutral | SpellDataFlags.AffectMinions | SpellDataFlags.AffectHeroes | SpellDataFlags.NotAffectSelf, default, true))
            {
...
namespace PreLoads
{
    public class XerathArcanopulseDamageExtended : IPreLoadScript
    {
        public void Preload()
        {
