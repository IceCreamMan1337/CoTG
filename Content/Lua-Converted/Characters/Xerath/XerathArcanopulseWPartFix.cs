namespace Spells
{
    public class XerathArcanopulseWPartFix : SpellScript
    {
...
namespace Buffs
{
    public class XerathArcanopulseWPartFix : BuffScript
    {
        public override void OnActivate()
        {
            ...
            Vector3 beam2 = GetPointByUnitFacingOffset(owner, 250, 0);
            Vector3 beam3 = GetPointByUnitFacingOffset(owner, 550, 0);
...
namespace PreLoads
{
    public class XerathArcanopulseWPartFix : IPreLoadScript
    {
        public void Preload()
        {
