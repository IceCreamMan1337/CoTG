    ...
    public class SkarnerFractureMissile : BuffScript
    {
            ...
            DamageSource damageSource)
        {
            ...
            if (caster == attacker)
            {
                ...
                healingAmount *= healingMod;
                SpellEffectCreate(out Particle motaExplosion /*UNUSED*/, out _, "Skarner_Fracture_Tar_Consume.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, target, default, default, target, default, default, true, false, false, false, false);
                IncHealth(attacker, healingAmount, attacker);
                SpellEffectCreate(out Particle healVFX /*UNUSED*/, out _, "galio_bulwark_heal.troy", default, TeamId.TEAM_UNKNOWN, 0, 0, TeamId.TEAM_UNKNOWN, default, attacker, false, attacker, default, default, attacker, default, default, true, false, false, false, false);
