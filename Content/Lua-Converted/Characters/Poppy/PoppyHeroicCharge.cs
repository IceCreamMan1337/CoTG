namespace Spells
{
    public class PoppyHeroicCharge : SpellScript
    {
            ...
            ref HitResult hitResult)
        {
            ...
            Vector3 nextBuffVars_CasterPos = GetUnitPosition(owner);
            ...
            AddBuff((ObjAIBase)target, owner, new Buffs.PoppyHeroicCharge(nextBuffVars_TargetPos, nextBuffVars_CasterPos, nextBuffVars_Damage, nextBuffVars_DamageTwo, nextBuffVars_WillRemove, nextBuffVars_SlashSpeed, nextBuffVars_WillMove), 1, 1, 0.25f + duration, BuffAddType.REPLACE_EXISTING, BuffType.COMBAT_ENCHANCER, 0, true, false, false);
...
namespace Buffs
{
    public class PoppyHeroicCharge : BuffScript
    {
        ...
        bool willMove;
        bool hasDoneInitialDamage;
        public PoppyHeroicCharge(Vector3 targetPos = default, Vector3 casterPos = default, float damage = default, float damageTwo = default, bool willRemove = default, float slashSpeed = default, bool willMove = default)
        {
            ...
            this.hasDoneInitialDamage = false;
        }
        ...
        public override void OnMoveSuccess()
        {
            ...
            else
            {
                ...
                float pushOffset = GetOffsetAngle(owner, casterPos);
                Vector3 newTargetPos = GetPointByUnitFacingOffset(owner, -400, pushOffset);
