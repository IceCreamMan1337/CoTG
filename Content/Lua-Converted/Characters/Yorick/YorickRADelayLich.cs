namespace Buffs
{
    public class YorickRADelayLich : BuffScript
    {
        ...
        public override void OnDeactivate(bool expired)
        {
            ...
            {
                AddBuff((ObjAIBase)owner, owner, new Buffs.YorickRAZombieLich(), 1, 1, 10, BuffAddType.RENEW_EXISTING, BuffType.COMBAT_ENCHANCER, 0, true, false, false);
            }
        }
...
namespace PreLoads
{
    public class YorickRADelayLich : IPreLoadScript
    {
        public void Preload()
        {
