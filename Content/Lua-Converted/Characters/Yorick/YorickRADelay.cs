namespace Buffs
{
    public class YorickRADelay : BuffScript
    {
        ...
        public override void OnDeactivate(bool expired)
        {
            ...
            {
                AddBuff((ObjAIBase)owner, owner, new Buffs.YorickRAZombie(), 1, 1, 10, BuffAddType.RENEW_EXISTING, BuffType.COMBAT_ENCHANCER, 0, true, false, false);
            }
        }
...
namespace PreLoads
{
    public class YorickRADelay : IPreLoadScript
    {
        public void Preload()
        {
