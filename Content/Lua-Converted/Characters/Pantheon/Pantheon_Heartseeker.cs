...
namespace Spells
{
    public class Pantheon_Heartseeker : SpellScript
    {
        ...
        {
            //this is mess 
            /* Vector3 castPosition = owner.Position3D; // UNITIALIZED
            ...
            Vector3 direction = (castPosition - owner.Position3D).Normalized();

            FaceDirection(owner, direction);

            Vector3 sourcePosition = owner.Position3D + (direction * -25);

            //nextBuffVars_CastPosition, nextBuffVars_sourcePosition


            AddBuff(owner, owner, new Buffs.Pantheon_Heartseeker(castPosition, sourcePosition), 1, 1, 0.75f, BuffAddType.REPLACE_EXISTING, BuffType.INTERNAL, 0.25f, true, false, false);
            AddBuff(owner, owner, new Buffs.Pantheon_HeartseekerSound(), 1, 1, 0.75f, BuffAddType.REPLACE_EXISTING, BuffType.COMBAT_ENCHANCER, 0, true, false, false);
            AddBuff(owner, owner, new Buffs.Pantheon_HeartseekerChannel(), 1, 1, 15, BuffAddType.REPLACE_EXISTING, BuffType.INTERNAL, 0, true, false, false);
