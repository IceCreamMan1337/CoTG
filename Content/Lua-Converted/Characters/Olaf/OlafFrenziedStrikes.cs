namespace Spells
{
    public class OlafFrenziedStrikes : SpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            AddBuff(owner, owner, new Buffs.OlafFrenziedStrikes(nextBuffVars_DamageGain, nextBuffVars_LifestealStat), 1, 1, 6, BuffAddType.REPLACE_EXISTING, BuffType.COMBAT_ENCHANCER, 0, true, false);
        }
    }
}
namespace Buffs
{
    public class OlafFrenziedStrikes : BuffScript
    {
