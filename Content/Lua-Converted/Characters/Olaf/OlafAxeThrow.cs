namespace Spells
{
    public class OlafAxeThrow : SpellScript
    {
        ...
        //hack moved onmissile end here
        public override void OnMissileEnd(string spellName, Vector3 missileEndPosition)
        {

            TeamId teamID = GetTeamID_CS(owner);
            Vector3 targetPos = missileEndPosition;
            Minion other3 = SpawnMinion("HiddenMinion", "OlafAxe", "idle.lua", targetPos, teamID, false, true, false, false, true, true, 0, default, false, (Champion)owner);
