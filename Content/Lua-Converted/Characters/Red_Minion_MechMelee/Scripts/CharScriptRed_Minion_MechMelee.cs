...
{
    public class CharScriptRed_Minion_MechMelee : CharScript
    {
        ...
        {
            if (damageSource == default && attacker is LaneTurret)
            {
                damageAmount *= 0.5f;
...
namespace PreLoads
{
    public class CharScriptRed_Minion_MechMelee : IPreLoadScript
    {
        public void Preload()
        {
