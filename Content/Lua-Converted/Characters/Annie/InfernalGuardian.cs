namespace Spells
{
    public class InfernalGuardian : SpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            //hack 
            //Minion other2 = SpawnMinion("Tibbers", "AnnieTibbers", "UncontrollablePet.lua", targetPos, teamID, false, false, false, false, false, false, 0, false, false);
            Pet other2 = SpawnPet("Tibbers", "AnnieTibbers", nameof(Buffs.InfernalGuardian), default, 45, targetPos, effect0[level - 1], effect1[level - 1]);
            //   Minion other2 = SpawnPet2("Tibbers", "AnnieTibbers", nameof(Buffs.InfernalGuardian), default, 45, targetPos, effect0[level - 1], effect1[level - 1]);

            FaceDirection(other2, targetPos);


            // AddBuff(owner, other2, new Buffs.InfernalGuardian(), 1, 1, 45, BuffAddType.REPLACE_EXISTING, BuffType.COMBAT_ENCHANCER, 0, true, false, false);
            ...
            AddBuff(owner, other2, new Buffs.InfernalGuardianBurning(nextBuffVars_ArmorAmount, nextBuffVars_MRAmount, nextBuffVars_HealthAmount, nextBuffVars_FinalDamage), 1, 1, 45, BuffAddType.REPLACE_EXISTING, BuffType.COMBAT_ENCHANCER, 0, true, false, false);
