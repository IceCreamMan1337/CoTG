...
namespace Buffs
{
    public class AbsoluteZero : BuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            {
                //hack was 100 stack
                AddBuff((ObjAIBase)owner, unit, new Buffs.AbsoluteZeroSlow(nextBuffVars_MovementSpeedMod, nextBuffVars_AttackSpeedMod), 1, 1, 3, BuffAddType.STACKS_AND_OVERLAPS, BuffType.SLOW, 0, true, false, false);
            }
            charVars.LifeTime = 0;
        }
