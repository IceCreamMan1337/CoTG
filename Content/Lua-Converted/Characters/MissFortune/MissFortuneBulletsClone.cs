namespace Spells
{
    public class MissFortuneBulletsClone : SpellScript
    {
            ...
            ref HitResult hitResult)
        {
            ...
            if (count <= 7)
            {
                int count1 = GetBuffCountFromAll(target, nameof(Buffs.MissFortunePlaceholder));
                if (count1 < 1)
                {
...
namespace Buffs
{
    public class MissFortuneBulletsClone : BuffScript
    {
...
namespace PreLoads
{
    public class MissFortuneBulletsClone : IPreLoadScript
    {
        public void Preload()
        {
