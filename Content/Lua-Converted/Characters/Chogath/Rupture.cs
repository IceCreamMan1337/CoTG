namespace Spells
{
    public class Rupture : SpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            Minion other3 = SpawnMinion("HiddenMinion", "TestCube", "idle.lua", targetPos, teamOfOwner, false, true, false, false, true, true, 0, default, true, (Champion)owner);
...
namespace Buffs
{
    public class Rupture : BuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            //   SpellEffectCreate(out _, out _, "rupture_cas_01.troy", default, teamID, 100, 0, TeamId.TEAM_UNKNOWN, default, owner, false, attacker, "bottom", default, target, default, default, true, default, default, false);
        ...
        public override void OnDeactivate(bool expired)
        {
            ...
            if (skin == 4)
            {
                ...
                SpellEffectCreate(out _, out _, "rupture_dino_cas_02.troy", default, teamID, 100, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, owner.Position3D, target, default, default, true, false, false, false, false);
            }
            else
            {
                ...
                SpellEffectCreate(out _, out _, "rupture_cas_02.troy", default, teamID, 100, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, owner.Position3D, target, default, default, true, false, false, false, false);
            }
