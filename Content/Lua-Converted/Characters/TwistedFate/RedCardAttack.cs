    ...
    public class RedCardAttack : SpellScript
    {
            ...
            ref HitResult hitResult)
        {
            ...
            if (target is ObjAIBase)
            {
                ...
                SpellEffectCreate(out _, out _, "PickaCard_red_tar.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, target, default, default, target, default, default, true, default, default, false);
            ...
            {
                Vector3 targetPosition = target.Position3D; // UNITIALIZED
                float baseDamage = GetBaseAttackDamage(attacker);
                SpellEffectCreate(out _, out _, "PickaCard_red_tar.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, targetPosition, default, default, targetPosition, false, default, default, false);
