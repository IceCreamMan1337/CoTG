namespace Spells
{
    public class XenZhaoThrust : SpellScript
    {
            ...
            ref HitResult hitResult)
        {
            ...
            SpellEffectCreate(out _, out _, "xenZiou_ChainAttack_cas_01.troy", default, TeamId.TEAM_UNKNOWN, 0, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target, default, default, false);
            SpellEffectCreate(out _, out _, "xenZiou_ChainAttack_01.troy", default, TeamId.TEAM_UNKNOWN, 0, 0, TeamId.TEAM_UNKNOWN, default, owner, false, target, default, default, target, default, default, false);
            SpellBuffRemove(owner, nameof(Buffs.XenZhaoComboTarget), owner);
