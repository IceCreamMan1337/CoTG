    ...
    public class NocturneDuskbringer : BuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            if (nocturneSkinID == 1)
            {
                ...
                SpellEffectCreate(out particle2, out particle, "NocturneDuskbringer_path_frost_green.troy", "NocturneDuskbringer_path_frost_red.troy", teamOfOwner, 240, 0, TeamId.TEAM_UNKNOWN, default, default, false, default, "head", owner.Position3D, owner, default, default, false, default, default, false, false, orientationPoint);
            }
            else if (nocturneSkinID == 4)
            {
                ...
                SpellEffectCreate(out particle2, out particle, "NocturneDuskbringer_path_ghost_green.troy", "NocturneDuskbringer_path_ghost_red.troy", teamOfOwner, 240, 0, TeamId.TEAM_UNKNOWN, default, default, false, default, "head", owner.Position3D, owner, default, default, false, default, default, false, false, orientationPoint);
            }
            else
            {
                ...
                SpellEffectCreate(out particle2, out particle, "NocturneDuskbringer_path_green.troy", "NocturneDuskbringer_path_red.troy", teamOfOwner, 240, 0, TeamId.TEAM_UNKNOWN, default, default, false, default, "head", owner.Position3D, owner, default, default, false, default, default, false, false, orientationPoint);
