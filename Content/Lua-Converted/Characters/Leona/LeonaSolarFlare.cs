...
namespace Buffs
{
    public class LeonaSolarFlare : BuffScript
    {
        ...
        public override void OnDeactivate(bool expired)
        {
            ...
            SpellEffectCreate(
                out _, out _,
                "Leona_SolarFlare_tar.troy", default,
                teamID, 10, 0, TeamId.TEAM_ORDER,
                default, default, false,
                null, "", owner.Position3D, // bindObject, boneName, pos
                null, "", owner.Position3D, // targetObject, targetBoneName, targetPos
...
namespace PreLoads
{
    public class LeonaSolarFlare : IPreLoadScript
    {
        public void Preload()
        {
