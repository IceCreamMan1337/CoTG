namespace Spells
{
    public class RivenTriCleave : SpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            AddBuff(owner, owner, new Buffs.RivenTriCleave(), 3, 1, 3.75f, BuffAddType.STACKS_AND_RENEWS, BuffType.COMBAT_ENCHANCER, 0, true, false, false);
            if (count == 0)
            {
                ...
                newCD *= 1;
                AddBuff(owner, owner, new Buffs.RivenTriCleaveCooldown(), 1, 1, newCD, BuffAddType.RENEW_EXISTING, BuffType.INTERNAL, 0, true, false, false);
            }
            float distance = 240;
            float maxRange = 240;
            ...
            if (count == 0)
            {
                ...
                AddBuff(owner, owner, new Buffs.RivenTriCleaveSoundOne(), 1, 1, 3, BuffAddType.REPLACE_EXISTING, BuffType.COMBAT_ENCHANCER, 0, true, false, true);
                AddBuff(owner, owner, new Buffs.RivenTriCleaveBuffer(), 1, 1, 0.4f, BuffAddType.REPLACE_EXISTING, BuffType.INTERNAL, 0, true, false, false);
                SetSlotSpellCooldownTimeVer2(0.25f, 0, SpellSlotType.SpellSlots, SpellbookType.SPELLBOOK_CHAMPION, owner, false);
                AddBuff(owner, owner, new Buffs.RivenTriCleaveDamage(nextBuffVars_Count), 1, 1, 1, BuffAddType.REPLACE_EXISTING, BuffType.INTERNAL, 0, true, false, false);
                AddBuff(owner, owner, new Buffs.UnlockAnimation(), 1, 1, 0.75f, BuffAddType.RENEW_EXISTING, BuffType.INTERNAL, 0, true, false, false);
            ...
            if (count == 1)
            {
                ...
                AddBuff(owner, owner, new Buffs.RivenTriCleaveSoundTwo(), 1, 1, 3, BuffAddType.REPLACE_EXISTING, BuffType.COMBAT_ENCHANCER, 0, true, false, true);
                AddBuff(owner, owner, new Buffs.RivenTriCleaveBufferB(), 1, 1, 0.4f, BuffAddType.REPLACE_EXISTING, BuffType.INTERNAL, 0, true, false, false);
                SetSlotSpellCooldownTimeVer2(0.25f, 0, SpellSlotType.SpellSlots, SpellbookType.SPELLBOOK_CHAMPION, owner, false);
                AddBuff(owner, owner, new Buffs.RivenTriCleaveDamage(nextBuffVars_Count), 1, 1, 1, BuffAddType.REPLACE_EXISTING, BuffType.INTERNAL, 0, true, false, false);
                AddBuff(owner, owner, new Buffs.UnlockAnimation(), 1, 1, 0.75f, BuffAddType.RENEW_EXISTING, BuffType.INTERNAL, 0, true, false, false);
                Move(owner, pos, 825, 15, 15, ForceMovementType.FURTHEST_WITHIN_RANGE, ForceMovementOrdersType.POSTPONE_CURRENT_ORDER, 275, ForceMovementOrdersFacing.KEEP_CURRENT_FACING);
            ...
            if (count == 2)
            {
                ...
                AddBuff(owner, owner, new Buffs.RivenTriCleaveSoundThree(), 1, 1, 3, BuffAddType.REPLACE_EXISTING, BuffType.COMBAT_ENCHANCER, 0, true, false, true);
                AddBuff(owner, owner, new Buffs.RivenTriCleaveDamage(nextBuffVars_Count), 1, 1, 1, BuffAddType.REPLACE_EXISTING, BuffType.INTERNAL, 0, true, false, false);
                AddBuff(owner, owner, new Buffs.UnlockAnimation(), 1, 1, 0.75f, BuffAddType.RENEW_EXISTING, BuffType.INTERNAL, 0, true, false, false);
            ...
            AddBuff(owner, owner, new Buffs.RivenSword(), 1, 1, 1.5f, BuffAddType.REPLACE_EXISTING, BuffType.INTERNAL, 0, true, false, false);
        }
...
namespace Buffs
{
    public class RivenTriCleave : BuffScript
    {
        ...
        public override void OnDeactivate(bool expired)
        {
            ...
            //hack 
            SetSlotSpellCooldownTimeVer2(13.0f, 0, SpellSlotType.SpellSlots, SpellbookType.SPELLBOOK_CHAMPION, (ObjAIBase)owner, false);
