...
namespace CoTG.CoTGServer.API
{
    public static class ApiEventManager
    {
        private static ILog _logger = LoggerProvider.GetLogger();
        private static List<DispatcherBase> _dispatchers = new();
        ...
        public static DataOnlyDispatcher<AttackableUnit, DeathData> OnAssist = new();
        ...
        public abstract class DispatcherBase<Source, CBType> : DispatcherBase
        {
            ...
            protected readonly List<Listener> _listeners = new();
            // Storage for Publish functions counters.
            protected List<int> _stack = new() { -1, -1, -1, -1, -1, -1, -1, -1 };
