...
namespace PacketDefinitions106
{
    ...
    public class PacketServer106
    {
        ...
        /// </summary>
        public PacketHandlerManager106 PacketHandlerManager { get; private set; }
        ...
        public PacketServer106(ushort port, string[] blowfishKeys)
        {
            ...
            PacketHandlerManager = new PacketHandlerManager106(blowfishes, _server);
        }
        ...
        /// <param name="netReq">Network request handler instance.</param>
        /// <param name="netResp">Network response handler instance.</param>
        public void InitServer(ushort port, string[] blowfishKeys)
        {
