...
namespace CoTG.CoTGServer.Content
{
    public static class GlobalData
    {
        ...
        public static DefaultStatValues DefaultStatValues { get; private set; } = new();
        public static GlobalCharacterDataConstants GlobalCharacterDataConstants { get; private set; } = new();
        public static DamageRatios DamageRatios { get; private set; } = new();
        public static ObjAIBaseVariables ObjAIBaseVariables { get; private set; } = new();
        public static AttackRangeVariables AttackRangeVariables { get; private set; } = new();
        public static AIAttackTargetSelectionVariables AIAttackTargetSelectionVariables { get; private set; } = new();
        public static SpellVampVariables SpellVampVariables { get; private set; } = new();
        public static AttackFlags AttackFlags { get; private set; } = new();
        public static MinionEXPMods MinionEXPMods { get; private set; } = new();
        public static ChampionVariables ChampionVariables { get; private set; } = new();
        public static ServerCulling ServerCulling { get; private set; } = new();
        public static BarrackVariables BarrackVariables { get; private set; } = new();
        public static ObjAIBuildingVariables ObjAIBuildingVariables { get; private set; } = new();
        public static SpawnPointVariables SpawnPointVariables { get; private set; } = new();
        public static NexusVariables NexusVariables { get; private set; } = new();
        public static CallForHelpVariables CallForHelpVariables { get; private set; } = new();

        public static void Init(Dictionary<string, float> constants)
        {
            _constants = constants;

            //defaultstats_LocalGold?
