...
namespace CoTG.CoTGServer.Content.Navigation
{
    ...
    public class NavigationGridCell
    {
        ...
        //test reverse from .126 
        public float AdditionalCost { get; private set; } = 10.0f;
        public float HintAsGoodCell { get; private set; } = 0.0f;
        ...
        /// </summary>
        public SortedList<GameObject, float> ActorList { get; private set; } = new SortedList<GameObject, float> { };

        //public Actor_Common ActorList { get; private set; }

        public uint AdditionalCostRefCount { get; private set; } = 0;
        ...
        //this->mRefHintNode[0] = -1;
        //this->mRefHintNode[1] = -1;
        public short[] RefHintNode { get; private set; } = new short[2] { -32768, -32768 };

        public HashSet<ObjAIBase> ActorList2 = new();

        public float TravelFactor { get; private set; } = 5.0f;

        public GameObject BlockingActor { get; private set; }

        public int AdditionalWall { get; private set; }
        ...
        public static NavigationGridCell ReadVersion5(BinaryReader br, int id)
        {
            ...
            NavigationGridLocator locator = new(br);
        ...
        /// <param name="positive">Value to set</param>
        public void SetFlags(NavigationGridCellFlags flags, bool positive = true)
        {
            if (positive)
            {
                Flags |= flags;
        ...
        /// <param name="blockingActor">Actor that is currently blocking the cell</param>
        public void CloseWithActor(AttackableUnit blockingActor)
        {
            IsOpen = false;
        ...
        {
            if (AdditionalWall > 0) return ((Flags | NavigationGridCellFlags.NOT_PASSABLE) & flag) == flag;
