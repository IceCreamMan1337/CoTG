...
//keep this in case we want do like league and use aimesh and aimesh_ngrid 



/////////////////////////////DEPRECATED just let them for information ////////////////////////////
namespace CoTG.CoTGServer.Content.Navigation.aimesh
{
    public class AIMesh
    {
        ...
        public float castRaySqr(Vector2 origin, Vector2 destination, bool inverseRay = false)
        {
            ...
            if (i == il)
            {
                return (/*TranslateToRealCoordinate*/new Vector2(x2, y2) - /*TranslateToRealCoordinate*/origin).Length();
            }

            return (/*TranslateToRealCoordinate*/new Vector2(x1, y1) - /*TranslateToRealCoordinate*/origin).Length();
        }
        ...
        public bool isAnythingBetween(ObjAIBase a, ObjAIBase b)
        {
            return default;
