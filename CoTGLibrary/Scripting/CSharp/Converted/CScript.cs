...
public class CScript : CScriptBase
{
    ...
    public StatsModifier? StatsModifier => null; //TODO: Make optional?
    ...
    protected void Activate()
    {
        ...
        //need understand why lua call sometimes the target ( the person who take damage ) 
        ...
        //sometimes lua ask the attacker 
        if (this.OnPreDamage2 != base.OnPreDamage2)
        {
            ApiEventManager.OnPreTakeDamage.AddListener(this, owner, (data) =>
            {
                var damageAmount = data.Damage;
                OnPreDamage2(data.Attacker, ref damageAmount, data.DamageType, data.DamageSource);
        ...
        if (this.OnAssist != base.OnAssist)
        {
            ApiEventManager.OnAssist.AddListener(this, owner, data => OnAssist((ObjAIBase)data.Killer, (ObjAIBase)data.Unit));
        }
        ...
        {
            ApiEventManager.OnBeingSpellHit.AddListener(this, owner, (target, spell, missile) => OnBeingSpellHit(spell.Caster, spell, spell.Script.ScriptMetadata));
        }
        if (this.OnCollision != base.OnCollision)
        {
            //TODO: Call once and only at the end of dashes
            ApiEventManager.OnCollision.AddListener(this, owner, (unit, with) => OnCollision());
        }
        if (this.OnCollisionTerrain != base.OnCollisionTerrain)
        {
            //TODO: Call once and only at the end of dashes
            ApiEventManager.OnCollisionTerrain.AddListener(this, owner, (unit) => OnCollisionTerrain());
        }
        ...
        if (owner is ObjAIBase a2)
        {
            ...
            {
                ApiEventManager.OnUnitSpellCast.AddListener(this, a2, spell => OnSpellCast(spell, spell.Name, spell.Script.ScriptMetadata));
            }
