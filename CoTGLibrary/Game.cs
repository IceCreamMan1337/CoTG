...
namespace CoTG.CoTGServer
{
    ...
    public partial class Game
    {
        ...
        public Game(Config config, ushort port)
        {
            ...
            _logger.Info("CoTGServer is ready to start!");
        ...
        /// <summary>
        /// TODO    : this will permit to communicate with api_server for say if CoTGServer start game or get error 
