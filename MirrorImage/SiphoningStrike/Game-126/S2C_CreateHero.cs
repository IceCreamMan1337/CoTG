...
namespace SiphoningStrike.Game
{
    public sealed class S2C_CreateHero : GamePacket // 0x04F
    {
        ...
        internal override void ReadBody(ByteReader reader)
        {
            ...
            if(GetVersioning() == "1.0.0.126")
                this.Name = reader.ReadFixedString(40); //if version 126 = 40 //if version 131 = 128 
            else
                this.Name = reader.ReadFixedString(128); //if version 126 = 40 //if version 131 = 128 
            if (GetVersioning() == "1.0.0.126")
                this.Skin = reader.ReadFixedString(40);
            else
                this.Skin = reader.ReadFixedString(40); //if version 126 = 40 //if version 131 = 128 
        }
        internal override void WriteBody(ByteWriter writer)
        {
            ...
            if (GetVersioning() == "1.0.0.126")
                ...
                writer.WriteFixedString(this.Name, 128);
            if (GetVersioning() == "1.0.0.126")
