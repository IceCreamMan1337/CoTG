...
namespace SiphoningStrike.Game.Common
{
    ...
    static class PlayerLoadInfoExtension
    {
...

        {
            ...
            if (BasePacket.GetVersioning() == "1.0.0.126") 
            ...
            { 
                ...
                {
                    data.BotName = reader.ReadFixedString(56);
                    data.BotSkinName = reader.ReadFixedString(56);
                }
            }
            else
            {
                ...
                {
                    data.BotName = reader.ReadFixedString(28);
                    data.BotSkinName = reader.ReadFixedString(28);
                }
            }
        ...
        public static void WritePlayerInfo(this ByteWriter writer, PlayerLoadInfo data)
        {
            ...
            if (BasePacket.GetVersioning() == "1.0.0.126")
            {
                if (data.IsBot == false)
                {
                    writer.WritePad(28);//why not 32 ??? 
                    writer.WritePad(28);//
                }
                else
                {
                    writer.WriteFixedString(data.BotName, 28);
                    writer.WriteFixedString(data.BotSkinName, 28);
                }
