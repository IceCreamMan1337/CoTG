...
namespace ChildrenOfTheGraveEnumNetwork.Enums
{
    ...
    {
        None,
        CallForHelpSuppressor = 1 << 0, //ApplyCallForHelpSuppresser
        CanAttack = 1 << 1,
        CanCast = 1 << 2,
        CanMove = 1 << 3,
        ...
        Disarmed = 1 << 7,     //ApplyDisarm
        Feared = 1 << 8,
        ForceRenderParticles = 1 << 9,
        GhostProof = 1 << 10,
        Ghosted = 1 << 11,
        IgnoreCallForHelp = 1 << 12,  //ApplyIgnoreCallForHelp
        ...
        MagicImmune = 1 << 15,
        NearSighted = 1 << 16,
        Netted = 1 << 17,    //ApplyNet
        NoRender = 1 << 18,
        Pacified = 1 << 19,  //ApplyPacified
        PhysicalImmune = 1 << 20,
        RevealSpecificUnit = 1 << 21,
        Rooted = 1 << 22,    //ApplyRoot
        Silenced = 1 << 23,  //ApplySilence
        Sleep = 1 << 24,
        Stealthed = 1 << 25,
        Stunned = 1 << 26,    //ApplyStun
        SuppressCallForHelp = 1 << 27,  //ApplySuppressCallForHelp
        Suppressed = 1 << 28, //ApplySuppression  // Deprecated before 4.20
        Targetable = 1 << 29,
        Taunted = 1 << 30
