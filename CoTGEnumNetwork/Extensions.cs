...
namespace CoTGEnumNetwork
{
    ...
    public static class Extensions
    {
        ...
        public static Vector3 ToVector3(this Vector2 vector, float Y) => new(vector.X, Y, vector.Y);
    ...
    {
        private static readonly Dictionary<int, TeamId> IntToTeamIdMap = new()
        {
            { 0, TeamId.TEAM_ORDER },
        ...
        {
            return IntToTeamIdMap.TryGetValue(i, out var teamId) ? teamId : (TeamId)2;
        }

        private static readonly Dictionary<TeamId, int> TeamIdToIntMap = new()
        {
            { TeamId.TEAM_ORDER, 0 },
            { TeamId.TEAM_CHAOS, 1 }
        };
        ...
        {
            return TeamIdToIntMap.TryGetValue(team, out var value) ? value : 2;
        }

        private static readonly Dictionary<TeamId, TeamId> EnemyTeamMap = new()
        {
        ...
        {
            return EnemyTeamMap.TryGetValue(team, out var enemyTeam) ? enemyTeam : (TeamId)2;
        }

        public static TeamId GetTeamFromString(this string? team)
        {
        ...
        public static bool CheckCircleCollision(this Vector2 pos1, float radius1, Vector2 pos2, float radius2)
        {
