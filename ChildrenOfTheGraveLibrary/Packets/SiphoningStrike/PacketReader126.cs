...
using ChildrenOfTheGraveEnumNetwork.Packets.PacketDefinitions.Requests;
...
using static PacketDefinitions126.PacketExtensions126;
...
namespace PacketDefinitions126
{
    ...
    /// </summary>
    /// TODO: Remove all ChildrenOfTheGrave based PacketCmd usage and replace with LeaguePackets' GamePacketID enum.
    public class PacketReader126
    {
        // this one only used in packet definitions, not exposed to the API currently, so no packet cmd assigned
        public static SiphoningStrike.KeyCheckPacket ReadKeyCheckRequest(byte[] data)
        {
            var rq = new SiphoningStrike.KeyCheckPacket();
            rq.Read(data);
            return rq;
        }

        [PacketType126(GamePacketID.C2S_SynchSimTime, Channel.CHL_GAMEPLAY)]
        ...
        [PacketType126(GamePacketID.C2S_RemoveItemReq)]
        ...
        [PacketType126(GamePacketID.C2S_QueryStatusReq)]
        ...
        [PacketType126(GamePacketID.C2S_Ping_Load_Info)]
        ...
        [PacketType126(GamePacketID.C2S_SwapItemReq)]
        ...
        [PacketType126(GamePacketID.C2S_World_SendCamera_Server)]
        ...
        [PacketType126(GamePacketID.C2S_NPC_UpgradeSpellReq)]
        ...
        [PacketType126(GamePacketID.C2S_UseObject)]
        ...
        [PacketType126(GamePacketID.C2S_PlayEmote)]
        ...
        [PacketType126(GamePacketID.C2S_ClientReady)]
        ...
        [PacketType126(GamePacketID.C2S_StatsUpdateReq)]
        ...
        [PacketType126(GamePacketID.C2S_MapPing)]
        ...
        [PacketType126(LoadScreenPacketID.RequestJoinTeam)]
        ...
        [PacketType126(Channel.CHL_COMMUNICATION)]
        ...
        [PacketType126(GamePacketID.C2S_OnTipEvent)]
        ...
        [PacketType126(GamePacketID.C2S_NPC_IssueOrderReq)]
        ...
        [PacketType126(GamePacketID.C2S_Waypoint_Acc, Channel.CHL_S2C)]
        ...
        [PacketType126(GamePacketID.C2S_World_LockCamera_Server)]
        ...
        [PacketType126(GamePacketID.C2S_BuyItemReq)]
        ...
        [PacketType126(GamePacketID.C2S_Exit)]
        ...
        [PacketType126(GamePacketID.C2S_NPC_CastSpellReq)]
        ...
        [PacketType126(GamePacketID.C2S_Reconnect)]
        ...
        [PacketType126(GamePacketID.BID_PausePacket)]
        ...
        [PacketType126(GamePacketID.C2S_TeamSurrenderVote)]
        ...
        [PacketType126(GamePacketID.C2S_OnReplication_Acc)]
        ...
        [PacketType126(GamePacketID.C2S_SendSelectedObjID)]
        ...
        [PacketType126(GamePacketID.C2S_SynchVersion)]
        ...
        [PacketType126(GamePacketID.C2S_CharSelected)]
        ...
        [PacketType126(GamePacketID.C2S_OnQuestEvent)]
        ...
        [PacketType126(GamePacketID.UNK_Cheat)]
        public static CheatRequest ReadCheatRequest(byte[] data)
        {
            var rq = new UNK_Cheat();
            rq.Read(data);
            return new CheatRequest(rq.IDCheat);
        }
#endif
        //UNKNOWN
