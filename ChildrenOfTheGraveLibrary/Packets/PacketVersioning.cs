...
using ChildrenOfTheGraveLibrary.Packets.PacketHandlers.SiphoningStrike;
using ChildrenOfTheGrave.ChildrenOfTheGraveServer.Packets.PacketHandlers;


using Siph = SiphoningStrike;
using Crys = CrystalSlash;
using ChildrenOfTheGraveLibrary.Packets.PacketHandlers.CrystalSlash;
...
namespace PacketVersioning
{
    public class PktVersioning
    {
        ...
        public static void TintNotify(TeamId team, bool enable, float speed, float maxWeight, ChildrenOfTheGraveEnumNetwork.Content.Color color)
        {
            switch (Game.Config.VersionOfClient)
            {
                case "1.0.0.106":
        ...
        public static void TintPlayerNotify(Champion champ, bool enable, float speed, ChildrenOfTheGraveEnumNetwork.Content.Color color)
        {
            switch (Game.Config.VersionOfClient)
            {
                case "1.0.0.106":
        ...
        public static void Basic_AttackNotify(ChildrenOfTheGrave.ChildrenOfTheGraveServer.GameObjects.SpellNS.CastInfo castInfo)
        {
            switch (Game.Config.VersionOfClient)
            {
                case "1.0.0.106":
        ...
        public static void Basic_Attack_PosNotify(ChildrenOfTheGrave.ChildrenOfTheGraveServer.GameObjects.SpellNS.CastInfo castInfo)
        {
            switch (Game.Config.VersionOfClient)
            {
                case "1.0.0.106":
        ...
        public static void NPC_CastSpellAnsNotify(ChildrenOfTheGrave.ChildrenOfTheGraveServer.GameObjects.SpellNS.CastInfo castInfo)
        {
            switch (Game.Config.VersionOfClient)
            {
                case "1.0.0.106":
